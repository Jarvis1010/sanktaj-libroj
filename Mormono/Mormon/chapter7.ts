export const chapter7 = {
  ...
  verses: [
    ...
    "Sciu, ke vi estas el la domo de Izrael.",
    "Sciu, ke vi devos veni al pento, aŭ vi ne povos esti savitaj.",
    "Sciu, ke vi devos demeti viajn ilojn de militado, kaj ne plu deziri verŝi sangon, kaj ne repreni ilin, krom kiam Dio ordonos tion al vi.",
    ...
    "Kaj li plenumas la releviĝon de la mortintoj, kio nepre relevos la homon por stari antaŭ lia tribunala seĝo.",
    ...
    "Tial pentu, kaj baptiĝu en la nomo de Jesuo, kaj prenu la evangelion de Kristo, kiu estos metita antaŭ vi, ne nur en ĉi tiu kroniko, sed ankaŭ en la kroniko, kiu venos de la judoj al la nejudoj, kaj kiu venos de la nejudoj al vi.",
    "Ĉar jen, ĉi tiu estas skribita por ke vi kredu tion; kaj, se vi kredas tion, vi kredos ankaŭ ĉi tiun, kaj se vi kredos ĉi tiun, vi scios pri viaj patroj, kaj ankaŭ pri la mirindaĵoj, kiujn la potenco de Dio faris inter ili.",
    "Kaj vi scios ankaŭ, ke vi estas restaĵo de la idaro de Jakob; vi do estas kalkulitaj inter la homoj de la unua interligo; kaj se vi kredas je Kristo, kaj baptiĝas, unue per akvo, poste per fajro kaj per la Sankta Spirito, sekvante la ekzemplon de nia Savinto, laŭ tio kion li ordonis al ni, al vi estos bone en la tago de juĝado.",
  ],
  footNotes: ["ĉ. 385 p.K."],
