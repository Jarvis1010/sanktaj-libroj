export const chapter1 = {
  ...
  verses: [
    ...
    "kiu nin savis kaj vokis per sankta voko, ne laŭ niaj faroj, sed laŭ Sia propra antaŭintenco kaj laŭ la graco donita al ni en Kristo Jesuo antaŭ tempoj eternaj,",
