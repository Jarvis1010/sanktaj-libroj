export const chapter2 = {
  ...
  verses: [
    ...
    "sed precipe tiujn, kiuj iras laŭ la karno en volupto de malpuraĵo, kaj malestimas regadon. Arogantaj, obstinaj, ili ne timas insulti aŭtoritatojn;",
    ...
    "en malbono ricevante pagon por malbono; homoj, kiuj opinias entagan diboĉon plezuro kaj estas makuloj kaj hontindaĵoj, diboĉante en sia uzado de la agapoj, dum ili kunfestenas kun vi;",
    ...
    "anoncante al ili liberecon, ili mem estas sklavoj de putreco; ĉar al kiu iu submetiĝas, al tiu ankaŭ li sklaviĝas.",
    "Ĉar se, forsaviĝinte el la malpuraĵoj de la mondo per la scio de la Sinjoro kaj Savanto Jesuo Kristo, ili estos denove tien implikitaj kaj venkitaj, ilia lasta stato fariĝos pli malbona, ol la unua.",
    "Ĉar estus por ili pli bone ne ekkoni la vojon de justeco, ol, ekkoninte ĝin, returni sin for de la sankta ordono al ili transdonita.",
