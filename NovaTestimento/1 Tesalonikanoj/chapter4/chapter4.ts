export const chapter4 = {
  ...
  verses: [
    ...
    "ĉar vi ja tion faras al ĉiuj fratoj, kiuj estas en la tuta Makedonujo. Sed ni admonas vin, fratoj, ke vi amu pli kaj pli abunde,",
    ...
    "Ĉar ni diras al vi per la vorto de la Sinjoro, ke ni, kiuj estos vivaj, restantaj ĝis la alveno de la Sinjoro, tute ne havos lokon antaŭ la endormiĝintoj.",
