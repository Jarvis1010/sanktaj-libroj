export const chapter4 = {
  ...
  verses: [
    ...
    "estu sciate al vi ĉiuj kaj al la tuta popolo Izraela, ke en la nomo de Jesuo Kristo, la Nazaretano, kiun vi krucumis, kiun Dio levis el la mortintoj, ĉi tiu staras sana antaŭ vi.",
    ...
    "Sed kiam ili rimarkis la kuraĝon de Petro kaj Johano, kaj komprenis, ke ili estas malkleruloj kaj nesciuloj, ili miris, kaj rekonis ilin, ke ili estis kun Jesuo.",
    ...
    "dirante:Kion ni devas fari al ĉi tiuj homoj? ĉar estas videble por ĉiuj loĝantoj en Jerusalem, ke rimarkinda signo fariĝis per ili, kaj nei ĝin ni ne povas.",
    ...
    "Kaj aŭdinte, ili levis la voĉon al Dio unuanime, kaj diris:Ho Plejpotenculo, kiu faris la ĉielon kaj la teron kaj la maron, kaj ĉion, kio estas en ili,",
    ...
    "Kaj post ilia preĝado skuiĝis la loko, en kiu ili kolektiĝis; kaj ili ĉiuj pleniĝis de la Sankta Spirito, kaj parolis kuraĝe la vorton de Dio.",
