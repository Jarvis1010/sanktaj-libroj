export const chapter17 = {
  ...
  verses: [
    ...
    "klarigante kaj montrante, ke la Kristo devis suferi kaj releviĝi el la mortintoj, kaj dirante:Ĉi tiu Jesuo, kiun mi predikas al vi, estas la Kristo.",
    "Kaj unuj el ili estis konvinkitaj, kaj kunsortiĝis kun Paŭlo kaj Silas; kaj el la piaj Grekoj granda amaso, kaj el la ĉefaj virinoj ne malmultaj.",
    "Sed la Judoj, enviante, varbis kelkajn malnoblulojn el la popolaĉo, kaj, kolektinte homamason, entumultigis la urbon; kaj atakinte la domon de Jason, ili klopodis elkonduki ilin al la popolo.",
    ...
    "Sed kiam la Judoj en Tesaloniko sciiĝis, ke ankaŭ en Berea la vorto de Dio estas proklamita de Paŭlo, ili venis ankaŭ tien, maltrankviligante kaj ekscitante la homamason.",
    "Kaj tiam la fratoj tuj forsendis Paŭlon, por ke li iru ĝis la marbordo; sed Silas kaj Timoteo restis ankoraŭ tie.",
    "Kaj la gvidantoj de Paŭlo kondukis lin ĝis Ateno, kaj ricevinte komision al Silas kaj Timoteo, ke ili venu al li kiel eble plej rapide, ili foriris.",
    "Kaj dum Paŭlo atendis ilin en Ateno, lia spirito ĉagreniĝis en li, kiam li vidis la urbon idolplena.",
    "Tial li rezonadis en la sinagogoj kun la Judoj kaj la diotimantoj, kaj sur la placo ĉiutage kun la renkontitoj.",
    "Kaj iuj el la Epikuranaj kaj Stoikaj filozofoj lin renkontis. Kaj unuj diris:Kion volus diri ĉi tiu vortŝutanto? aliaj diris:Li ŝajnas esti proklamanto de fremdaj diaĵoj; ĉar li predikis Jesuon kaj la releviĝon.",
    ...
    "Ĉar preterpasante kaj rigardante viajn adorataĵojn, mi trovis ankaŭ altaron, sur kiu estis skribite:AL DIO NEKONATA. Kiun do vi nekonante adoras, Tiun mi predikas al vi.",
    ...
    "tial Li difinis tagon, en kiu Li juĝos la mondon en justeco per tiu viro, kiun Li elektis, doninte garantion pri tio al ĉiuj homoj per tio, ke Li relevis lin el la mortintoj.",
