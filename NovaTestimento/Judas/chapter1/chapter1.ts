export const chapter1 = {
  ...
  verses: [
    ...
    "Ĉar enŝteliĝis iuj homoj, jam antaŭ longe destinitaj por ĉi tiu kondamno, malpiuloj, ŝanĝante la gracon de nia Dio en diboĉecon, kaj malkonfesante la solan Estron kaj nian Sinjoron Jesuo Kristo.",
    ...
    "Kaj anĝelojn, kiuj ne konservis sian regadon, sed forlasis sian propran loĝejon, Li rezervis sub mallumo en katenoj ĉiamaj ĝis la juĝo en la granda tago.",
    ...
    "Ili estas la subakvaj rokoj en viaj agapoj, kun vi kunfestenante, sentime sin paŝtante; nuboj senakvaj, per vento disportataj; aŭtunaj arboj senfruktaj, dufoje mortintaj, elradikigitaj;",
