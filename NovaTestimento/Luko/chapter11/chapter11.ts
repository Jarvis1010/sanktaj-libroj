export const chapter11 = {
  ...
  verses: [
    ...
    "Kaj de kiu el vi, kiu estas patro, filo petos panon, kaj li donos al li ŝtonon? aŭ se li petas fiŝon, ĉu li anstataŭ fiŝo donos al li serpenton?",
    ...
    "Sed li, sciante iliajn pensojn, diris al ili:Ĉiu regno, dividita kontraŭ si, dezertiĝas; kaj domo, dividita kontraŭ domo, falas.",
    ...
    "Kiam la malpura spirito eliris el homo, ĝi trairas tra senakvaj lokoj, serĉante ripozon; kaj ne trovante ĝin, diras:Mi reiros al mia domo, el kie mi eliris.",
    ...
    "Kaj dum li ĉi tion parolis, unu virino el la homamaso levis sian voĉon, kaj diris al li:Feliĉaj estas la ventro, kiu naskis vin, kaj la mamoj, kiujn vi suĉis.",
    "Sed li diris:Sed pli ĝuste, feliĉaj estas tiuj, kiuj aŭdas la vorton de Dio kaj observas ĝin.",
    "Kaj kiam la homamaso kolektiĝis al li, li ekparolis, dirante:Ĉi tiu generacio estas malbona generacio; ĝi serĉas signon, kaj signo ne estos donita al ĝi, krom la signo de Jona.",
    "Ĉar kiel Jona estis signo por la Nineveanoj, tiel ankaŭ estos la Filo de homo por ĉi tiu generacio.",
    "La reĝino de la sudo leviĝos en la juĝado kun la viroj de ĉi tiu generacio, kaj ilin kondamnos; ĉar ŝi venis el la finoj de la tero, por aŭskulti la saĝon de Salomono; kaj jen iu pli granda ol Salomono estas ĉi tie.",
    "Viroj Nineveanoj staros en la juĝado kun ĉi tiu generacio, kaj ĝin kondamnos; ĉar ili pentis pro la predikado de Jona; kaj jen iu pli granda ol Jona estas ĉi tie.",
    ...
    "La lampo de via korpo estas via okulo; kiam via okulo estas sendifekta, via tuta korpo estas luma; sed kiam ĝi estas malbona, via korpo ankaŭ estas malluma.",
    "Tial viglu, ke la lumo, kiu estas en vi, ne estu mallumo.",
    "Tial, se via tuta korpo estas luma, havante nenian malluman parton, ĝi estos tute lumplena, kiel kiam la lampo lumas al vi per sia brilo.",
    ...
    "Kaj li diris:Ve ankaŭ al vi, leĝistoj! ĉar vi ŝarĝas homojn per ŝarĝoj malfacile porteblaj, kaj vi mem ne tuŝas eĉ per unu el viaj fingroj la ŝarĝojn.",
