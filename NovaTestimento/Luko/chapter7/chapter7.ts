export const chapter7 = {
  ...
  verses: [
    ...
    "Kaj Jesuo ekiris kun ili. Kaj kiam li estis ne malproksime de la domo, la centestro sendis al li amikojn, por diri al li:Sinjoro, ne ĝenu vin; ĉar mi ne estas inda, ke vi venu sub mian tegmenton;",
    "pro tio mi ne opiniis min inda veni al vi. Sed vorton parolu, kaj mia knabo saniĝos.",
    "Ĉar mi ankaŭ estas homo metita sub aŭtoritato, havante sub mi soldatojn; kaj mi diras al ĉi tiu:Iru; kaj li iras; kaj al alia:Venu; kaj li venas; kaj al mia sklavo:Faru ĉi tion; kaj li ĝin faras.",
    ...
    "Kaj kiam li alproksimiĝis al la pordego de la urbo, jen oni elportis mortinton, la solan filon de lia patrino, kaj ŝi estis vidvino; kaj granda homamaso el la urbo estis kun ŝi.",
    ...
    "Kaj li respondis kaj diris al ili:Iru kaj sciigu Johanon pri tio, kion vi vidis kaj aŭdis:blinduloj vidas, lamuloj marŝas, lepruloj estas purigitaj, kaj surduloj aŭdas, mortintoj leviĝas, al malriĉuloj evangelio estas predikata.",
    ...
    "Sed kion vi eliris, por vidi? ĉu homon per mola vestaro vestitan? Jen tiuj, kiuj portas luksan vestaron kaj delikate vivadas, troviĝas en domoj de reĝoj.",
    ...
    "kaj starante malantaŭe ĉe liaj piedoj, plorante, ŝi komencis priverŝi liajn piedojn per siaj larmoj, kaj viŝis ilin per la haroj de sia kapo, kaj kisadis liajn piedojn, kaj ŝmiris ilin per la ŝmiraĵo.",
