export const chapter16 = {
  ...
  verses: [
    ...
    "Tiam li diris al alia:Kaj kiom vi ŝuldas? Kaj li diris:Cent kor�ojn da tritiko. Li diris al li:Prenu vian kalkulon, kaj skribu okdek.",
    ...
    "Kaj li ekkriis, kaj diris:Patro Abraham, kompatu min, kaj sendu Lazaron, por ke li trempu en akvon la pinton de sia fingro, por malvarmigi mian langon; ĉar mi tre suferas en ĉi tiu flamo.",
    "Sed Abraham diris:Filo, memoru, ke dum via vivo vi ricevis viajn bonaĵojn, kaj Lazaro tiel same malbonaĵojn; sed nun li ricevas konsolon, kaj vi suferas.",
    "Kaj krom ĉio tio staras granda abismo inter ni kaj vi, tiel ke tiuj, kiuj volus iri de ĉi tie al vi, ne povas, kaj oni ne povas transiri de tie al ni.",
    ...
    "Kaj li diris al li:Se ili ne aŭskultas Moseon kaj la profetojn, ili ne kredos, eĉ se iu leviĝus el la mortintoj.",
  ],
