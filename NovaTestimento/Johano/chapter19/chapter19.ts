export const chapter19 = {
  ...
  verses: [
    ...
    "Kiam do la ĉefpastroj kaj oficistoj lin vidis, ili kriis:Krucumu, krucumu lin. Pilato diris al ili:Mem prenu lin kaj krucumu lin, ĉar mi trovas en li nenian kulpon.",
    ...
    "Ĉe tio Pilato penis liberigi lin; sed la Judoj kriis, dirante:Se vi liberigos tiun, vi ne estas amiko de Cezaro; ĉiu, kiu pretendas esti reĝo, parolas kontraŭ Cezaro.",
    ...
    "Ili kriegis:Forigu, forigu, krucumu lin. Pilato diris al ili:Ĉu mi krucumu vian Reĝon? La ĉefpastroj respondis:Ni ne havas reĝon krom Cezaro.",
    ...
    "Kaj la soldatoj, kiam ili krucumis Jesuon, prenis liajn vestojn, kaj dividis ilin en kvar partojn, po unu parto por ĉiu soldato; kaj la tunikon; sed la tuniko estis senkudra, desupre teksita tra la tuto.",
    "Ili do diris unu al alia:Ni ne disŝiru ĝin, sed lotu pri ĝi, kies ĝi estos; por ke plenumiĝu la Skribo, kiu diras: Ili dividis miajn vestojn inter si,   Pri mia tuniko ili lotis.  Tion la soldatoj faris.",
    ...
    "Kuŝis tie vazo plena de vinagro; oni do metis spongon, plenigitan per la vinagro, sur hisopon, kaj levis ĝin al lia buŝo.",
    "Kiam do Jesuo ricevis la vinagron, li diris:Estas finite; kaj, klininte sian kapon, li ellasis for la spiriton.",
    "La Judoj, ĉar estis la Preparado, por ke la korpoj ne restadu sur la krucoj dum la sabato (ĉar la tago de tiu sabato estis granda tago), petis Pilaton, ke oni rompu iliajn krurojn, kaj forportu ilin.",
    ...
    "Post tio, Jozef el Arimateo, kiu estis disĉiplo de Jesuo, sed sekrete pro timo antaŭ la Judoj, petis Pilaton, ke li povu forpreni la korpon de Jesuo; kaj Pilato permesis. Li do venis kaj forprenis lian korpon.",
    "Venis ankaŭ Nikodemo (tiu, kiu unue venis al Jesuo nokte), portanta miksaĵon de mirho kaj aloo, ĉirkaŭ cent funtoj.",
