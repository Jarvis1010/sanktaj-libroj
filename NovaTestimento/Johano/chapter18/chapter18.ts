export const chapter18 = {
  ...
  verses: [
    ...
    "Kaj Simon Petro sekvis Jesuon, kaj ankaŭ alia disĉiplo. Ĉi tiu disĉiplo estis konata de la ĉefpastro, kaj eniris kun Jesuo en la korton de la ĉefpastro;",
    ...
    "Jesuo respondis al li:Mi parolis malkaŝe al la mondo; mi ĉiam instruis en la sinagogoj kaj en la templo, kie ĉiuj Judoj kunvenas; kaj sekrete mi nenion parolis.",
    ...
    "Kaj oni kondukis Jesuon de Kajafas en la palacon; estis frumatene; kaj ili ne eniris en la palacon, por ke ili ne malpuriĝu, sed povu manĝi la Paskon.",
    ...
    "Jesuo respondis:Mia regno ne estas el ĉi tiu mondo; se mia regno estus el ĉi tiu mondo, miaj servantoj bataladus, por ke mi ne transdoniĝu al la Judoj; sed nun mia regno ne estas el ĉi tie.",
    "Pilato demandis lin:Ĉu vi do estas reĝo? Jesuo respondis:Vi diras, ke mi estas reĝo. Por tio mi naskiĝis kaj venis en la mondon, ke mi atestu pri la vero. Ĉiu, kiu estas el la vero, aŭskultas mian voĉon.",
