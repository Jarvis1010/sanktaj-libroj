export const chapter4 = {
  ...
  verses: [
    ...
    "en kiuj la dio de ĉi tiu mondo blindigis la animojn de la nekredantoj, por ke la lumo de la evangelio de la gloro de Kristo, kiu estas la bildo de Dio, ne brilu sur ilin.",
