export const chapter16 = {
  ...
  verses: [
    ...
    "Kaj Jesuo responde diris al li:Feliĉa vi estas, Simon Bar-Jona; ĉar ne karno kaj sango tion malkaŝis al vi, sed mia Patro, kiu estas en la ĉielo.",
    ...
    "Sed turninte sin, li diris al Petro:Iru malantaŭ min, Satano; vi estas faligilo por mi, ĉar vi havas pensojn ne laŭ Dio, sed laŭ homoj.",
