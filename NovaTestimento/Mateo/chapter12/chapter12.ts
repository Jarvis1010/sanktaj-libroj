export const chapter12 = {
  ...
  verses: [
    ...
    "Kaj al iu, kiu parolos vorton kontraŭ la Filo de homo, tio estos pardonita; sed al iu, kiu parolos kontraŭ la Sankta Spirito, tio ne estos pardonita en ĉi tiu mondo, nek en la venonta.",
