export const chapter18 = {
  ...
  verses: [
    ...
    "kaj diris:Vere mi diras al vi:Se vi ne turniĝos kaj ne fariĝos kiel infanoj, vi neniel eniros en la regnon de la ĉielo.",
    ...
    "sed kiu igos fali unu el ĉi tiuj malgranduloj, kiuj kredas al mi, estus pli bone por tiu, se granda muelŝtono estus pendigita ĉirkaŭ lia kolo, kaj se li estus subakvigita en la profundon de la maro.",
    ...
    "Kaj se via okulo faligas vin, elŝiru ĝin kaj forĵetu ĝin de vi; estas bone por vi eniri en vivon unuokula prefere ol, havante du okulojn,  esti enĵetita en Gehenan de fajro.",
    "Gardu vin, ke vi ne malestimu unu el tiuj malgranduloj; ĉar mi diras al vi, ke iliaj anĝeloj en la ĉielo ĉiam rigardas la vizaĝon de mia Patro, kiu estas en la ĉielo.",
    ...
    "Kaj se okazas, ke li trovas ĝin, vere mi diras al vi, li plimulte ĝojas pri ĝi, ol pri la naŭdek naŭ, kiuj ne erarvagis.",
    ...
    "Kaj se li rifuzos aŭskulti ilin, diru la aferon al la eklezio; kaj se li ankaŭ rifuzos aŭskulti la eklezion, li estu por vi kiel fremdulo kaj impostisto.",
