export const chapter19 = {
  ...
  verses: [
    ...
    "Kaj ĉiu, kiu forlasis domojn aŭ fratojn aŭ fratinojn aŭ patron aŭ patrinon aŭ infanojn aŭ kampojn pro mia nomo, ricevos multoble kaj heredos eternan vivon.",
