export const chapter13 = {
  ...
  verses: [
    ...
    "Tial mi parolas al ili per paraboloj; ĉar vidante, ili ne rimarkas, kaj aŭdante, ili ne aŭdas nek komprenas.",
    ...
    "Ĉar la koro de tiu popolo grasiĝis, Kaj iliaj oreloj aŭdas malklare,   Kaj siajn okulojn ili fermis;   Por ke ili ne vidu per siaj okuloj,   Kaj ne aŭdu per siaj oreloj,   Kaj ne komprenu per sia koro,   Kaj ne rekonvertiĝu,   Kaj ke Mi ne sanigu ilin.",
    "Sed feliĉaj estas viaj okuloj, ĉar ili vidas; kaj viaj oreloj, ĉar ili aŭdas.",
    "Vere mi diras al vi, ke multaj profetoj kaj justuloj deziris vidi tion, kion vi vidas, sed ili ne vidis; kaj aŭdi tion, kion vi aŭdas, sed ili ne aŭdis.",
    "Vi do aŭdu la parabolon de la semisto.",
    "Kiam iu aŭdas la vorton de la regno kaj ne komprenas ĝin, tiam venas la malbonulo, kaj forprenas tion, kio estas semita en lia koro. Ĉi tiu estas la ricevinta semon apud la vojo.",
    ...
    "Kaj kiu ricevis semon inter la dornoj, estas tiu, kiu aŭdas la vorton; sed la zorgoj de la mondo kaj la trompo de riĉo sufokas la vorton, kaj li fariĝas senfrukta.",
    ...
    "Lasu al ambaŭ kreski kune ĝis la rikolto; kaj en la tempo de la rikolto mi diros al la rikoltistoj:Kolektu unue la lolon, kaj ligu ĝin en faskojn, por bruligi ĝin; sed kolektu la tritikon en mian grenejon.",
    ...
    "ĝi vere estas pli malgranda ol ĉiuj semoj, sed kreskinte, ĝi estas pli granda ol la legomoj, kaj fariĝas arbo, tiel ke venas la birdoj de la ĉielo kaj loĝas en ĝiaj branĉoj.",
    "Alian parabolon li parolis al ili:La regno de la ĉielo similas al fermentaĵo, kiun virino prenis kaj kaŝis en tri mezurojn da faruno, ĝis la tuto fermentis.",
    ...
    "Tiam forsendinte la homamasojn, li venis en la domon; kaj liaj disĉiploj venis al li, dirante:Klarigu al ni la parabolon pri la lolo de la kampo.",
    ...
    "La regno de la ĉielo similas al kaŝita en kampo trezoro, kiun viro trovis kaj kaŝis, kaj pro ĝojo li iras kaj vendas ĉion, kion li posedas, kaj aĉetas tiun kampon.",
    ...
    "Kaj li diris al ili:Tial ĉiu skribisto, disĉipligita en la regnon de la ĉielo, similas al dommastro, kiu elportas el sia trezorejo objektojn novajn kaj malnovajn.",
