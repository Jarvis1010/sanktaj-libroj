export const chapter9 = {
  ...
  verses: [
    ...
    "Kaj Jesuo, forpasante de tie, vidis viron nomatan Mateo, sidantan ĉe la impostejo; kaj li diris al li:Sekvu min. Kaj li stariĝis, kaj sekvis lin.",
    ...
    "Kaj Jesuo diris al ili:Ĉu la filoj de la edziĝejo povas malĝoji, dum la fianĉo estas kun ili? Sed venos tagoj, kiam la fianĉo estos prenita for de ili, kaj tiam ili fastos.",
    ...
    "Ankaŭ oni ne enverŝas novan vinon en malnovajn felsakojn; alie la felsakoj krevos, kaj la vino elfluos, kaj la felsakoj detruiĝos; sed oni enverŝas novan vinon en novajn felsakojn, kaj ambaŭ konserviĝas.",
    ...
    "Kaj kiam li venis en la domon, la blinduloj alvenis al li, kaj Jesuo diris al ili:Ĉu vi kredas, ke mi povas fari ĉi tion? Ili diris al li:Jes, Sinjoro.",
    ...
    "Kaj Jesuo trairis ĉiujn urbojn kaj vilaĝojn, instruante en iliaj sinagogoj, kaj predikante la evangelion de la regno, kaj sanigante ĉian malsanon kaj ĉian malfortaĵon.",
