export const chapter6 = {
  ...
  verses: [
    ...
    "Ĉu ĉi tiu ne estas la ĉarpentisto, filo de Maria, kaj frato de Jakobo kaj Joses kaj Judas kaj Simon? kaj ĉu liaj fratinoj ne estas ĉi tie ĉe ni? Kaj ili ofendiĝis pro li.",
    ...
    "Kaj se ie ajn oni vin ne akceptos, nek vin aŭskultos, tiam el tie forirante, deskuu la polvon, kiu estas sub viaj piedoj, por atesto al ili.",
    ...
    "Kaj la reĝo Herodo aŭdis pri tio, ĉar lia nomo jam konatiĝis; kaj li diris:Johano, la Baptisto, leviĝis el la mortintoj, kaj tial tiuj potencaĵoj energias en li.",
    ...
    "Ĉar Herodo mem jam sendis, kaj arestis Johanon, kaj ligis lin en malliberejo pro Herodias, kiu estis edzino de lia frato Filipo, ĉar li estis edziĝinta kun ŝi.",
    ...
    "ĉar Herodo timis Johanon, sciante, ke li estas viro justa kaj sankta, kaj nepre gardis lin. Kaj aŭskultante lin, li embarasiĝis, kaj aŭskultis lin volonte.",
    ...
    "eniris la filino de Herodias mem kaj dancis, kaj ŝi plaĉis al Herodo kaj al liaj kunmanĝantoj; kaj la reĝo diris al la knabino:Petu de mi, kion ajn vi volas, kaj mi tion donos al vi.",
    ...
    "Sed li responde diris al ili:Vi donu al ili manĝi. Kaj ili diris al li:Ĉu ni iru kaj aĉetu panojn por ducent denaroj, kaj donu al ili manĝi?",
    ...
    "Kaj li prenis la kvin panojn kaj la du fiŝojn, kaj suprenrigardinte al la ĉielo, li benis kaj dispecigis la panojn, kaj donis al la disĉiploj, por meti antaŭ ilin; kaj li dividis la du fiŝojn inter ĉiuj.",
    ...
    "Kaj vidante ilin laborantaj en malfacila remado, ĉar la vento estis kontraŭa al ili, ĉirkaŭ la kvara gardoparto de la nokto li venis al ili, irante sur la maro, kaj li volis preterpasi ilin;",
    ...
    "kaj kuris tra tiu tuta regiono, kaj komencis ĉirkaŭporti la malsanulojn sur iliaj litoj tien, kie ili aŭdis, ke li estas.",
    "Kaj kien ajn li eniris, en vilaĝojn aŭ en urbojn aŭ sur la kamparon, ili demetis la malsanulojn sur la placoj, kaj petegis lin, ke ili tuŝu nur la randon de lia vesto; kaj ĉiuj, kiuj tuŝis, resaniĝis.",
  ],
