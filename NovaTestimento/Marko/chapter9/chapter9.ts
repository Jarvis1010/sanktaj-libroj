export const chapter9 = {
  ...
  verses: [
    ...
    "Kaj li diris al ili:Vere Elija venas antaŭe, kaj restarigas ĉion; kaj kiel estas skribite pri la Filo de homo, ke li devas multe suferi kaj esti malestimata?",
    ...
    "Kaj kiam Jesuo vidis, ke homamaso alkuras, li severe admonis la malpuran spiriton, dirante al ĝi:Vi muta kaj surda spirito, mi ordonas al vi:Eliru el li, kaj ne plu eniru en lin.",
    ...
    "Ĉar li instruadis siajn disĉiplojn, kaj diris al ili:La Filo de homo estas transdonita en la manojn de homoj, kaj ili mortigos lin; kaj, mortigite, li leviĝos post tri tagoj.",
    ...
    "Kaj se via piedo faligas vin, detranĉu ĝin:estas bone por vi eniri en vivon lama prefere ol, havante du piedojn, esti ĵetita en Gehenan,",
    "kie ilia vermo ne pereas kaj la fajro ne estingiĝas.",
    "Kaj se via okulo faligas vin, elŝiru ĝin:estas bone por vi eniri en la regnon de Dio kun unu okulo prefere ol, havante du okulojn, esti ĵetita en Gehenan,",
    "kie ilia vermo ne pereas kaj la fajro ne estingiĝas.",
