export const chapter12 = {
  ...
  verses: [
    ...
    "Kaj ili celis kapti lin, sed ili timis la homamason; ĉar ili eksciis, ke li parolis la parabolon kontraŭ ili; kaj forlasinte lin, ili foriris.",
    "Kaj ili sendis al li iujn el la Fariseoj kaj el la Herodanoj, por impliki lin per interparolado.",
    "Kaj veninte, ili diris al li:Majstro, ni scias, ke vi estas verama kaj ne zorgas pri iu ajn; ĉar vi ne favoras la personon de homoj, sed instruas laŭ vero la vojon de Dio. Ĉu konvenas doni tributon al Cezaro, aŭ ne?",
