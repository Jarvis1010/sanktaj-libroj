export const chapter2 = {
  ...
  verses: [
    ...
    "sed laŭ via obstineco kaj senpenta koro vi amasigas por vi koleron en la tago de kolero kaj malkaŝigo de la justa juĝo de Dio,",
    ...
    "sed Judo estas tiu, kiu estas interne tia, kaj cirkumcido estas en la koro, laŭ la spirito, ne laŭ la litero, kies laŭdo estas ne de homoj, sed de Dio.",
  ],
