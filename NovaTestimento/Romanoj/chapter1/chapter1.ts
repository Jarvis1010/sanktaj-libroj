export const chapter1 = {
  ...
  verses: [
    ...
    "Kaj mi ne volas, ke vi nesciu, fratoj, ke ofte mi celis veni al vi (sed mi estas malhelpita ĝis nun), por ke mi havu iom da frukto ĉe vi, kiel ankaŭ ĉe la aliaj nacioj.",
    ...
    "kaj tiel same ankaŭ la viroj, forlasante la naturan uzadon de la virino, brulis en sia volupto unu al alia, kaj viroj kun viroj faris hontindaĵon kaj ricevis en si mem la taŭgan rekompencon de sia malvirto.",
