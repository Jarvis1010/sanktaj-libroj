export const chapter11 = {
  ...
  verses: [
    ...
    "Per la fido ĥanoĥ estis transportita, por ne vidi morton; kaj li ne estis trovata, ĉar Dio lin transportis; ĉar antaŭ lia transporto estis atestite pri li, ke li plaĉis al Dio;",
    ...
    "Ĉiuj tiuj mortis en fido, ne ricevinte la promesojn, sed vidinte kaj salutinte ilin de malproksime, kaj konfesinte, ke ili estas fremduloj kaj migrantoj sur la tero.",
    ...
    "Sed nun pli bonan landon ili celas, tio estas, ĉielan; tial Dio ne hontas pri ili, esti nomata ilia Dio; ĉar Li por ili pretigis urbon.",
