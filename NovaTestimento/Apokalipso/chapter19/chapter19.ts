export const chapter19 = {
  ...
  verses: [
    ...
    "Kaj la besto estis kaptita, kaj kun ĝi la falsa profeto, kiu faris antaŭ ĝi la signojn, per kiuj li trompis tiujn, kiuj ricevis la markon de la besto kaj adorkliniĝis al ĝia bildo; ili ambaŭ estis ĵetitaj vivaj en la lagon fajran, brulantan per sulfuro;",
