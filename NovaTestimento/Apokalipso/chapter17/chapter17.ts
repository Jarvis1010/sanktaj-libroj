export const chapter17 = {
  ...
  verses: [
    ...
    "La besto, kiun vi vidis, ekzistis, sed ne ekzistas, kaj venos supren el la abismo kaj iros en pereon. Kaj la loĝantoj sur la tero, kies nomoj ne estas skribitaj en la libro de vivo jam de la fondo de la mondo, miros, kiam ili vidos la beston, ke ĝi ekzistis kaj ne ekzistas, sed venos.",
