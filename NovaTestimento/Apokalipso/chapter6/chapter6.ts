export const chapter6 = {
  ...
  verses: [
    ...
    "Kaj eliris alia ĉevalo, flamkolora; kaj al la sidanta sur ĝi estis donite forpreni pacon de la tero, kaj ke oni mortigu unu la alian; kaj al li estis donita granda glavo.",
    ...
    "Kaj mi aŭdis kvazaŭ voĉon, meze de la kvar kreitaĵoj, dirantan:Mezuro da tritiko por denaro, kaj tri mezuroj da hordeo por denaro; kaj la oleon kaj la vinon ne difektu.",
    "Kaj kiam li malfermis la kvaran sigelon, mi aŭdis la voĉon de la kvara kreitaĵo dirantan:Venu.",
    "Kaj mi rigardis, kaj jen pala ĉevalo; kaj la nomo de la sidanta sur ĝi estis Morto; kaj Hades sekvis kun li. Kaj estis donita al ili aŭtoritato super kvarono de la tero, por mortigi per glavo kaj per malsato kaj per morto kaj per la sovaĝaj bestoj de la tero.",
    ...
    "Kaj estis donita al ĉiu el ili blanka robo; kaj estis dirite al ili, ke ili atendu ankoraŭ kelkan tempon, ĝis ankaŭ iliaj kunservistoj kaj iliaj fratoj, mortigotaj kiel ili mem, plensumiĝos.",
    "Kaj mi rigardis, kiam li malfermis la sesan sigelon, kaj fariĝis granda tertremo; kaj la suno fariĝis nigra kiel sakaĵo el haroj, kaj la tuta luno fariĝis kiel sango;",
    ...
    "Kaj la reĝoj de la tero kaj la granduloj kaj la milestroj kaj la riĉuloj kaj la fortuloj kaj ĉiu sklavo kaj ĉiu liberulo sin kaŝis en la kavernoj kaj inter la rokoj de la montoj;",
