export const chapter4 = {
  ...
  verses: [
    ...
    "Kaj ĉirkaŭ la trono estis dudek kvar tronoj; kaj sur la tronoj mi vidis dudek kvar presbiterojn sidantajn, vestitajn per blankaj vestoj; kaj sur iliaj kapoj orajn kronojn.",
    ...
    "la dudek kvar presbiteroj falos antaŭ la Sidanto sur la trono, kaj ili adorkliniĝos al la Vivanto por ĉiam kaj eterne, kaj ĵetos siajn kronojn antaŭ la trono, dirante:",
