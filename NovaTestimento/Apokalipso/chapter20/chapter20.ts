export const chapter20 = {
  ...
  verses: [
    ...
    "kaj ĵetis lin en la abismon kaj fermis ĝin kaj sigelis ĝin super li, por ke li ne plu trompu la naciojn, ĝis finiĝos la mil jaroj; post tio li devos esti malligita por kelka tempo.",
    "Kaj mi vidis tronojn, kaj oni sidis sur ili, kaj juĝo estis donita al ili; kaj mi vidis la animojn de la senkapigitaj pro la atesto de Jesuo kaj pro la vorto de Dio, kaj tiujn, kiuj ne adorkliniĝis al la besto, nek al ĝia bildo, kaj ne ricevis la markon sur sia frunto kaj sur sia mano; kaj ili vivis, kaj ili reĝis kun Kristo mil jarojn.",
    "La ceteraj mortintoj ne vivis, ĝis finiĝos la mil jaroj. Tio estas la unua releviĝo.",
    "Feliĉa kaj sankta estas la partoprenanto en la unua releviĝo; super tiuj la dua morto havas nenian aŭtoritaton; sed ili estos pastroj de Dio kaj de Kristo, kaj reĝos kun li mil jarojn.",
    ...
    "Kaj la diablo, kiu trompis ilin, estis ĵetita en la lagon fajran kaj sulfuran, kie troviĝas la besto kaj la falsa profeto; kaj ili estos turmentataj tage kaj nokte por ĉiam kaj eterne.",
    ...
    "Kaj mi vidis la mortintojn, grandajn kaj malgrandajn, starantajn antaŭ la trono; kaj libroj estis malfermitaj; kaj estis malfermita alia libro, kiu estas la libro de vivo; kaj la mortintoj estis juĝataj el la skribitaĵoj en la libroj, laŭ siaj faroj.",
