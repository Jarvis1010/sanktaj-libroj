export const comeThouFont = {
  ...
  verses: [
    ...
    "Kiel granda mia ŝuldo al la graco de l' Sinjor'! Mi submetu min al muldo, kiu faros min trezor', Ĉar mi scias min malforta, forvagema; tamen mi Min konfidas al senmorta amo de l' savanta Di'.",
  ],
