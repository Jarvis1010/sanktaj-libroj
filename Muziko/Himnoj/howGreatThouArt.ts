export const howGreatThouArt = {
  ...
  verses: [
    ...
    "Kaj kiam mi memoras pri la gloro de mia savo per la Krist-ofer', Mi klinas min kun adorad-fervoro, dankante Vin kun pura kor-sincer'. Animo mia gloras Vin per kant', ho granda Di', ho granda Di'! Animo mia gloras Vin per kant', ho granda Di', ho granda Di'!",
    "Kaj fine falos ĉiuj tempvualoj, kaj bonvenigos nin Emanuel'; Ravege sonos la anĝel-ĥoraloj; ekĝuos mi la gloron de l' ĉiel'. Des pli mi laŭde gloros Vin per kant', kaj dankos Vin, ho bona Di'! Des pli mi laŭde gloros Vin per kant', kaj dankos Vin, ho bona Di'!",
  ],
