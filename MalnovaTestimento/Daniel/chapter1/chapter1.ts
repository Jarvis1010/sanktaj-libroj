export const chapter1 = {
  ...
  verses: [
    ...
    "La reĝo parolis kun ili, kaj el ili ĉiuj troviĝis neniu egala al Daniel, ĥananja, Miŝael, kaj Azarja. Kaj ili komencis servadi antaŭ la reĝo.",
    "Kaj koncerne ĉiujn aferojn de saĝo kaj scio, pri kiuj la reĝo ilin demandis, li trovis ilin dekoble pli saĝaj, ol ĉiuj astrologoj kaj magiistoj, kiuj estis en lia tuta regno.",
