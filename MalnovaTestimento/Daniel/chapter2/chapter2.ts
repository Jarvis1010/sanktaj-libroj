export const chapter2 = {
  ...
  verses: [
    ...
    "Sed la reĝo respondis kaj diris al la ĥaldeoj:La enhavon mi forgesis. Tamen, se vi ne diros al mi la sonĝon kaj ĝian signifon, vi estos dishakitaj en pecojn kaj viaj domoj estos ruinigitaj.",
    "Sed se vi rakontos al mi la sonĝon kaj ĝian signifon, vi ricevos de mi donacojn, rekompencon, kaj grandan honoron. Tial diru al mi la sonĝon kaj ĝian signifon.",
    ...
    "Se vi ne diros al mi la sonĝon, tio montros, ke vi havas unu intencon:vi preparas vin, por doni al mi mensogan kaj sentaŭgan respondon, ĝis la tempo pasos. Tial rakontu al mi la sonĝon, tiam mi konvinkiĝos, ke vi povas klarigi al mi ankaŭ ĝian signifon.",
    "La ĥaldeoj respondis al la reĝo kaj diris:Ne ekzistas sur la tero tia homo, kiu povus plenumi la deziron de la reĝo; tial neniu reĝo, kiel ajn granda kaj potenca li estus, postulis iam similan respondon de iu astrologo, magiisto, aŭ ĥaldeo;",
    ...
    "Tiam Daniel faris saĝan kaj prudentan rediron al ArjoĤ, la estro de la reĝaj korpogardistoj, kiu eliris, por mortigi la saĝulojn de Babel;",
    ...
    "Poste Daniel iris al ArjoĤ, al kiu la reĝo komisiis mortigi la saĝulojn de Babel; li venis, kaj diris al li tiel:Ne mortigu la saĝulojn de Babel, konduku min al la reĝo, kaj mi diros al la reĝo la klarigon.",
    "Tiam ArjoĤ tuj enkondukis Danielon al la reĝo, kaj diris al ĉi tiu tiele:Inter la transloĝigitaj filoj de Judujo mi trovis homon, kiu povas doni al la reĝo klarigon.",
    ...
    "Daniel respondis al la reĝo kaj diris:La kaŝitaĵon, pri kiu la reĝo demandas, ne povas malkaŝi al la reĝo la saĝuloj, nek la sorĉistoj, nek la astrologoj, nek la divenistoj;",
    "sed en la ĉielo ekzistas Dio, kiu malkaŝas kaŝitaĵon; Li malkaŝis al la reĝo Nebukadnecar tion, kio estos en tempo estonta. Via sonĝo kaj la vizioj de via kapo sur via lito estis jenaj:",
    ...
    "Tiam ĉio kune frakasiĝis:la fero, argilo, kupro, arĝento, kaj oro fariĝis kiel grenventumaĵo sur somera draŝejo, kaj la vento ilin forportis, kaj ne restis postesigno post ili; sed la ŝtono, kiu frakasis la statuon, fariĝis granda monto kaj plenigis la tutan teron.",
    ...
    "La kvara regno estos malmola, kiel fero; ĉar kiel fero disbatas kaj frakasas ĉion, tiel ankaŭ ĝi, simile al ĉiofrakasanta fero, disbatados kaj frakasados.",
    "Kaj ke vi vidis la piedojn kaj la fingrojn parte el potargilo kaj parte el fero-tio estos regno de miksita konsisto, kaj ĝi enhavos parte la malmolecon de fero, ĉar vi vidis feron miksitan kun potargilo.",
    ...
    "Kaj ke vi vidis feron, miksitan kun potargilo, tio signifas, ke ili estos kunigitaj per forto homa, sed ne kunfandiĝos inter si, kiel fero ne kunfandiĝas kun argilo.",
    "Sed en la tempo de tiuj reĝoj Dio de la ĉielo starigos regnon, kiu neniam detruiĝos, kaj ĝia reĝado ne transiros al alia popolo; ĝi frakasos kaj detruos ĉiujn regnojn, sed ĝi mem staros eterne.",
    "Vi vidis, ke ŝtono sen ia mano deŝiriĝis de monto, kaj frakasis feron, kupron, argilon, arĝenton, kaj oron; la granda Dio montris al la reĝo, kio estos poste. Tia estas precize la sonĝo kaj ĝia ĝusta klarigo.",
    ...
    "Tiam la reĝo altigis Danielon, donis al li grandajn kaj riĉajn donacojn, kaj faris lin reganto super la tuta lando de Babel kaj ĉefo super ĉiuj saĝuloj de Babel.",
    "Daniel petis la reĝon, kaj ĉi tiu starigis ŜadraĤon, MeŝaĤon, kaj Abed-Negon super la aferoj de la lando Babela; kaj Daniel mem restis ĉe la kortego de la reĝo.",
  ],
