export const chapter14 = {
  ...
  verses: [
    ...
    "kaj ili diros al la loĝantoj de tiu lando, kiuj aŭdis, ke Vi, la Eternulo, estas meze de ĉi tiu popolo, kaj ke Vi, la Eternulo, montris Vin al ili okulon kontraŭ okulo, kaj ke Via nubo staras super ili, kaj ke Vi iras antaŭ ili dum la tago en nuba kolono kaj dum la nokto en kolono fajra;",
    ...
    "La Eternulo estas longepacienca kaj multe favorkora; Li pardonas kulpon kaj krimon, sed antaŭ Li neniu estas senkulpa; Li punas la kulpon de patroj sur filoj kaj nepoj, en la tria kaj kvara generacioj.",
    ...
    "en ĉi tiu dezerto falos viaj kadavroj, kaj el ĉiuj viaj kalkulitoj, laŭ via tuta kalkulo, en la aĝo de dudek jaroj kaj pli, kiuj murmuris kontraŭ Mi,",
    ...
    "Laŭ la nombro de la tagoj, dum kiuj vi esplorrigardis la landon, kvardek tagoj, po jaro pro ĉiu tago, vi portos la punon pro via malbonago dum kvardek jaroj, por ke vi ekkonu Mian malfavoron.",
