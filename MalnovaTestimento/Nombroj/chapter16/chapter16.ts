export const chapter16 = {
  ...
  verses: [
    ...
    "Sed se novan aperon kreos la Eternulo, kaj la tero malfermos sian buŝon, kaj englutos ilin, kaj ĉion, kio apartenas al ili, kaj ili vivaj malsupreniros en Ŝeolon, tiam sciu, ke ĉi tiuj homoj blasfemis kontraŭ la Eternulo.",
