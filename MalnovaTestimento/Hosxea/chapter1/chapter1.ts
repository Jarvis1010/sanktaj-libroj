export const chapter1 = {
  ...
  verses: [
    ...
    "Kaj ŝi denove gravediĝis kaj naskis filinon; kaj Li diris al li:Donu al ŝi la nomon Lo-Ruĥama; ĉar Mi ne plu kompatos la domon de Izrael, sed postulos de ili pagon.",
