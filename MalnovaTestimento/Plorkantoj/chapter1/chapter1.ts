export const chapter1 = {
  ...
  verses: [
    ...
    "Elmigris Jehuda pro mizero kaj tro malfacila laborado; Li ekloĝis inter la nacioj, sed ne trovas ripozon;   Ĉiuj liaj persekutantoj atingis lin en malvastaj lokoj.",
    "La vojoj de Cion estas malĝojaj, ĉar neniu iras al festoj; Ĉiuj ĝiaj pordegoj dezertiĝis, ĝiaj pastroj ĝemas;   Ĝiaj virgulinoj ploras, kaj al ĝi mem estas tre maldolĉe.",
    ...
    "En la tagoj de sia mizero kaj suferoj Jerusalem rememoras ĉiujn ĉarmaĵojn, kiujn ŝi havis en la tempoj pasintaj; Dume nun ŝia popolo enfalis en la manon de premanto, kaj neniu ŝin helpas,   La malamikoj ŝin rigardas kaj ridas pri ŝia ruiniĝo.",
    ...
    "Oni aŭdas, kiel mi ĝemas, sed neniu min konsolas; Ĉiuj miaj malamikoj aŭdis pri mia malfeliĉo, kaj ekĝojis, ĉar Vi tion faris;   Venigu do la tagon, kiam Vi proklamos, ke ili fariĝu kiel mi.",
    "Ilia tuta malboneco venu antaŭ Vin; Kaj agu kun ili tiel, kiel Vi agis kun mi pro ĉiuj miaj pekoj;   Ĉar granda estas mia ĝemado, kaj mia koro doloras.",
  ],
