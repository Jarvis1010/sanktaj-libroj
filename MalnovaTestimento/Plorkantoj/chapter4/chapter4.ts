export const chapter4 = {
  ...
  verses: [
    ...
    "La lango de suĉinfano algluiĝis al ĝia palato pro soifo; Infanoj petas panon, sed neniu donas al ili.",
    ...
    "La pekoj de la filino de mia popolo estas pli grandaj, ol la pekoj de Sodom, Kiu estis renversita momente, kaj manoj ĝin ne turmentis.",
    ...
    "Finiĝis viaj malbonagoj, ho filino de Cion; Li vin ne plu forkondukigos; Sed viajn malbonagojn, ho filino de Edom, Li punos, Li malkovros viajn pekojn.",
  ],
