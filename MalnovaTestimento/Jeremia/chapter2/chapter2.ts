export const chapter2 = {
  ...
  verses: [
    ...
    "Kaj ili ne diris:Kie estas la Eternulo, kiu elkondukis nin el la Egipta lando, kiu kondukis nin tra dezerto, tra lando de stepoj kaj kavoj, tra lando seka kaj malluma, tra lando, kiun neniu trapasis kaj kie neniu loĝis?",
    ...
    "La pastroj ne diris:Kie estas la Eternulo? la leĝokompetentuloj ne atentis Min, la paŝtistoj perfidis Min, la profetoj profetis per Baal kaj sekvis idolojn.",
