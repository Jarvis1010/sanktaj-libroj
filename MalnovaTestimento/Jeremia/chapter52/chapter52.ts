export const chapter52 = {
  ...
  verses: [
    ...
    "tiam oni faris enrompon en la urbon; kaj ĉiuj militistoj forkuris, kaj eliris el la urbo nokte, laŭ la vojo de la pordego inter la du muregoj apud la ĝardeno de la reĝo, kaj foriris laŭ la vojo al la stepo. Kaj la ĥaldeoj staris ĉirkaŭ la urbo.",
    ...
    "En la kvina monato, en la deka tago de la monato, tio estas en la dek- naŭa jaro de la reĝo Nebukadnecar, reĝo de Babel, venis Nebuzaradan, estro de la korpogardistoj, kiu ĉiam estis apud la reĝo de Babel, en Jerusalemon.",
    ...
    "La malriĉulojn el la urbo, kaj la ceteran popolon, kiu restis en la urbo, kaj la transkurintojn, kiuj transkuris al la reĝo de Babel, kaj la ceteran popolamason forkondukis Nebuzaradan, la estro de la korpogardistoj.",
    ...
    "Kaj el la urbo li prenis unu korteganon, kiu estis super la militistoj, kaj sep virojn el la adjutantoj de la reĝo, kiuj troviĝis en la urbo, kaj la skribiston de la militestro, kiu enregistradis militistojn el la popolo de la lando, kaj sesdek homojn el la popolo de la lando, kiuj troviĝis en la urbo.",
    ...
    "en la dudek-tria jaro de Nebukadnecar la korpogardistestro Nebuzaradan elhejmigis sepcent kvardek kvin homojn el la Judoj:la kvanto de ĉiuj estis kvar mil sescent homoj.",
    "En la tridek-sepa jaro post la elpatrujigo de Jehojaĥin, reĝo de Judujo, en la dek-dua monato, en la dudek-kvina tago de la monato, Evil- Merodaĥ, reĝo de Babel, en la unua jaro de sia reĝado, levis la kapon de Jehojaĥin, reĝo de Judujo, kaj elirigis lin el la malliberejo;",
