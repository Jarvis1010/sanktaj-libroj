export const chapter17 = {
  ...
  verses: [
    ...
    "Kiam la reĝo de Asirio rimarkis ĉe Hoŝea perfidon, ĉar li sendis senditojn al So, reĝo de Egiptujo, kaj ne liveris tributon al la reĝo de Asirio, kiel ĉiujare, tiam la reĝo de Asirio kaptis lin kaj metis lin en malliberejon.",
    "Kaj la reĝo de Asirio iris kontraŭ la tutan landon, venis al Samario, kaj sieĝis ĝin dum tri jaroj.",
    "En la naŭa jaro de Hoŝea la reĝo de Asirio venkoprenis Samarion, kaj transkondukis la Izraelidojn en Asirion, kaj loĝigis ilin en ĥalaĤ, kaj en ĥabor, ĉe la rivero Gozan, kaj en la urboj de la Medoj.",
    "Ĉar la Izraelidoj pekis kontraŭ la Eternulo, ilia Dio, kiu elkondukis ilin el la lando Egipta, el sub la mano de Faraono, reĝo de Egiptujo, kaj ili adoradis aliajn diojn,",
    ...
    "Kaj la Eternulo avertis la Izraelidojn kaj la Judojn per ĉiuj Siaj profetoj kaj viziistoj, dirante:Returnu vin de viaj malbonaj vojoj, kaj plenumu Miajn ordonojn kaj leĝojn, laŭ la tuta instruo, kiun Mi donis al viaj patroj kaj kiun Mi sendis al vi per Miaj servantoj, la profetoj.",
    ...
    "kaj ili malestimis Liajn leĝojn, kaj Lian interligon, kiun Li faris kun iliaj patroj, kaj Liajn avertojn, per kiuj Li avertis ilin, kaj ili sekvis vantaĵon kaj vantiĝis, kaj sekvis la naciojn, kiuj estis ĉirkaŭ ili kaj pri kiuj la Eternulo ordonis al ili, ke ili ne imitu ilin;",
    "kaj ili forlasis ĉiujn ordonojn de la Eternulo, ilia Dio, kaj faris al si fandaĵon de du bovidoj kaj faris sanktan stangon kaj adorkliniĝis antaŭ la tuta armeo de la ĉielo kaj servis al Baal;",
    "kaj ili trairigadis siajn filojn kaj siajn filinojn tra fajro kaj sorĉadis kaj aŭguradis kaj fordonis sin al farado de malbono antaŭ la okuloj de la Eternulo, por inciti Lin.",
    ...
    "Ĉar la Izraelidoj defalis de la domo de David, kaj prenis al si kiel reĝon Jerobeamon, filon de Nebat; kaj Jerobeam deturnis Izraelon de la Eternulo kaj entiris ilin en grandan pekon.",
    "Kaj la Izraelidoj iradis en ĉiuj pekoj de Jerobeam, kiujn li faris, ne deturnante sin de ili,",
    "ĝis la Eternulo forpuŝis Izraelon de antaŭ Sia vizaĝo, kiel Li diris per ĉiuj Siaj servantoj, la profetoj; kaj Izrael estas elpelita el sia lando en Asirion ĝis la nuna tago.",
    "Kaj la reĝo de Asirio transkondukis homojn el Babel, Kut, Ava, ĥamat, kaj Sefarvaim, kaj ekloĝigis ilin en la urboj de Samario anstataŭ la Izraelidoj. Kaj ili ekposedis Samarion kaj ekloĝis en ĝiaj urboj.",
    ...
    "Oni raportis al la reĝo de Asirio, dirante:La popoloj, kiujn vi transkondukis kaj loĝigis en la urboj de Samario, ne konas la leĝojn de la Dio de la lando, kaj tial Li sendis kontraŭ ilin leonojn, kiuj nun mortigas ilin, ĉar ili ne konas la leĝojn de la Dio de la lando.",
