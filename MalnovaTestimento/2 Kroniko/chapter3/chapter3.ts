export const chapter3 = {
  ...
  verses: [
    ...
    "Kaj jene Salomono faris la fundamenton, por konstrui la domon de Dio:la longo estis laŭ la antaŭa ulnomezuro sesdek ulnoj, kaj la larĝo dudek ulnoj;",
    ...
    "La grandan domon li tabulkovris per ligno cipresa kaj tegis ĝin per pura oro kaj faris sur ĝi palmornamojn kaj ĉenornamojn.",
    "Kaj li garnis la domon per multekostaj ŝtonoj por beleco; la oro estis oro Parvaima.",
    "Kaj li kovris la domon, la trabojn, la sojlojn, ĝiajn murojn, kaj ĝiajn pordojn per oro, kaj li skulptigis kerubojn sur la muroj.",
    "Kaj li faris la plejsanktejon; ĝia longo, konforme al la larĝo de la domo, estis dudek ulnoj, kaj ĝia larĝo estis dudek ulnoj; kaj li tegis ĝin per bona oro en la kvanto de sescent kikaroj.",
