export const chapter24 = {
  ...
  verses: [
    ...
    "Kaj li kunvokis la pastrojn kaj la Levidojn, kaj diris al ili:Iru en la urbojn de Judujo kaj kolektu de ĉiuj Izraelidoj monon por riparadi la domon de via Dio ĉiujare; kaj rapidu kun tiu afero. Sed la Levidoj ne rapidis.",
    "Tiam la reĝo alvokis Jehojadan, ilian ĉefon, kaj diris al li:Kial vi ne postulas de la Levidoj, ke ili alportadu el Judujo kaj Jerusalem la imposton, kiun Moseo, la servanto de la Eternulo, kaj la komunumo de Izrael starigis por la tabernaklo de la interligo?",
    ...
    "Kaj ĉiufoje, kiam oni alportis la keston per la Levidoj en la reĝan oficejon, kaj oni vidis, ke estas multe da mono, venis skribisto de la reĝo kaj komisiito de la ĉefpastro, kaj ili malplenigis la keston, kaj poste oni reportis ĝin kaj restarigis sur ĝia loko. Tiel oni faradis ĉiutage, kaj oni kolektis multe da mono.",
    "Kaj la reĝo kaj Jehojada donadis ĝin al la farantoj de la laboroj en la domo de la Eternulo, kaj oni dungis ŝtonhakistojn kaj ĉarpentistojn, por renovigi la domon de la Eternulo, ankaŭ feraĵistojn kaj kupraĵistojn, por ripari la domon de la Eternulo.",
    ...
    "Kiam ili finis, ili alportis la restintan monon al la reĝo kaj al Jehojada; el tio oni faris vazojn por la domo de la Eternulo, vazojn por la servado kaj por la bruloferoj, kalikojn kaj aliajn vazojn orajn kaj arĝentajn. Kaj oni alportadis bruloferojn en la domo de la Eternulo konstante, dum la tuta vivo de Jehojada.",
    ...
    "Kun nemulte da homoj venis la militistaro de Sirio; tamen la Eternulo transdonis en ilian manon la militistaron multe pli grandan, pro tio, ke ĉi tiuj forlasis la Eternulon, Dion de iliaj patroj. Kaj sur Joaŝ ili faris juĝon.",
    "Kiam ili foriris de li, lasinte lin en grava malsano, liaj servantoj faris konspiron kontraŭ li pro la sango de la filoj de Jehojada, la pastro, kaj ili mortigis lin sur lia lito, kaj li mortis. Kaj oni enterigis lin en la urbo de David, sed oni ne enterigis lin en la reĝaj tomboj.",
