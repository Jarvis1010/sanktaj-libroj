export const chapter9 = {
  ...
  verses: [
    ...
    "kaj la manĝaĵon de lia tablo kaj la loĝejon de liaj sklavoj kaj la oficojn de liaj servantoj kaj iliajn vestojn, liajn vinverŝistojn kaj iliajn vestojn, kaj lian iradon, kiam li iris en la domon de la Eternulo; kaj ŝi estis tute ravita.",
    "Kaj ŝi diris al la reĝo:Vera estas tio, kion mi aŭdis en mia lando pri viaj aferoj kaj pri via saĝeco;",
    "mi ne kredis iliajn vortojn, ĝis mi venis kaj ĝis miaj okuloj ekvidis; sed nun mi vidas, ke oni ne rakontis al mi eĉ duonon de via granda saĝeco:vi superas la famon, kiun mi aŭdis.",
    "Feliĉaj estas viaj homoj, kaj feliĉaj estas viaj servantoj, kiuj ĉiam staras antaŭ vi kaj aŭdas vian saĝecon.",
    "Benata estu la Eternulo, via Dio, kiu favoras vin kaj sidigis vin sur via trono kiel reĝon antaŭ la Eternulo, via Dio. Pro amo de via Dio al la Izraelidoj, por fortikigi ilin por ĉiam, Li faris vin reĝo super ili, por ke vi zorgu pri juĝo kaj justeco.",
    "Kaj ŝi donacis al la reĝo cent dudek kikarojn da oro kaj tre multe da aromaĵoj kaj multekostajn ŝtonojn; neniam estis aromaĵoj similaj al tiuj, kiujn la reĝino de Ŝeba donacis al la reĝo Salomono.",
    ...
    "Kaj la reĝo Salomono donis al la reĝino de Ŝeba ĉion, kion ŝi deziris kaj kion ŝi petis, krom tio, kion ŝi alportis al la reĝo. Kaj ŝi foriris returne en sian landon, ŝi kaj ŝiaj servantoj.",
    ...
    "Kaj ses ŝtupojn havis la trono, kaj oran piedbenketon, alfortikigitajn al la trono, kaj brakapogojn ambaŭflanke de la sidloko, kaj du leonojn, starantajn apud la brakapogoj.",
    "Kaj ankoraŭ dek du leonoj tie staris sur la ses ŝtupoj ambaŭflanke; io simila ne ekzistis en iu regno.",
    "Kaj ĉiuj trinkvazoj de la reĝo Salomono estis el oro, kaj ĉiuj vazoj de la Lebanona arbardomo estis el pura oro; arĝento en la tempo de Salomono estis rigardata kiel senvalora.",
    "Ĉar la reĝo havis ŝipojn, kiuj iradis en Tarŝiŝon kun la servantoj de ĥiram; unu fojon en tri jaroj venadis la ŝipoj el Tarŝiŝ, alportante oron, arĝenton, eburon, simiojn, kaj pavojn.",
