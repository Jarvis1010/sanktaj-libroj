export const chapter30 = {
  ...
  verses: [
    ...
    "en tia okazo mi sciigas al vi hodiaŭ, ke vi pereos, ke vi ne longe vivos sur la tero, sur kiun vi transiras trans Jordanon, por veni tien kaj ekposedi ĝin.",
    ...
    "amante la Eternulon, vian Dion, aŭskultante Lian voĉon kaj alkroĉante vin al Li; ĉar Li estas via vivo kaj via longatempeco de loĝado sur la tero, pri kiu la Eternulo ĵuris al viaj patroj, al Abraham, al Isaak, kaj al Jakob, ke Li donos al ili.",
  ],
