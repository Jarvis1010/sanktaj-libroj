export const chapter18 = {
  ...
  verses: [
    ...
    "Kaj se venos Levido el iu el viaj urboj, el la tuta Izrael, kie li loĝas, kaj li venos pro la tuta deziro de sia animo al la loko, kiun elektos la Eternulo,",
