export const chapter29 = {
  ...
  verses: [
    ...
    "kaj kiam li aŭdos la vortojn de ĉi tiu malbeno, li benos sin en sia koro, dirante:Paco estos al mi, malgraŭ tio, ke mi iros laŭ la deziroj de mia koro; kaj pereos la trinkintoj kune kun la soifantoj.",
    ...
    "sulfuro kaj salo, bruligitaĵo estas la tuta lando; ĝi ne estas prisemata kaj ne naskas, kaj nenia herbo tie elkreskas, simile al la ruinoj de Sodom kaj Gomora, Adma kaj Ceboim, kiujn la Eternulo ruinigis en Sia kolero kaj en Sia furiozo-",
