export const chapter3 = {
  ...
  verses: [
    ...
    "Kaj la Eternulo, nia Dio, transdonis en nian manon ankaŭ Ogon, la reĝon de Baŝan, kaj lian tutan popolon; kaj ni batis lin tiel, ke neniu restis ĉe li.",
    ...
    "Kaj ni ekstermis ilin, kiel ni faris al SiĤon, la reĝo de ĥeŝbon, ni ekstermis en ĉiu urbo la virojn, la virinojn, kaj la infanojn;",
    "sed ĉiujn brutojn kaj la rabaĵon el la urboj ni prenis al ni, kiel militakiraĵon.",
    "Kaj ni prenis tiam el la manoj de la du reĝoj de la Amoridoj la landon, kiu estas transe de Jordan, de la torento Arnon ĝis la monto ĥermon",
    ...
    "(Ĉar nur Og, la reĝo de Baŝan, estis restinta el la resto de la Rafaidoj. Jen estas lia lito, fera lito, jen ĝi estas en Raba de la Amonidoj:naŭ ulnoj estas ĝia longeco kaj kvar ulnoj estas ĝia larĝeco, laŭ la ulnoj de viro.)",
    ...
    "Jair, filo de Manase, prenis la tutan distrikton de Argob ĝis la limo de la Geŝuridoj kaj MaaĤatidoj, kaj li donis al Baŝan laŭ sia nomo la nomon Vilaĝoj de Jair, tiel estas ĝis nun.)",
    ...
    "kaj la stepon, kun Jordan por limo, de Kineret ĝis la maro de la ebenaĵo, la Sala Maro, ĉe la bazo de Pisga en la oriento.",
    ...
    "ĝis la Eternulo donos ripozon al viaj fratoj, kiel al vi, kaj ili ankaŭ ekposedos la landon, kiun la Eternulo, via Dio, donas al ili transe de Jordan; tiam vi reiros ĉiu al sia posedaĵo, kiun mi donis al vi.",
