export const chapter8 = {
  ...
  verses: [
    ...
    "Konservu min kiel sigelon en via koro, kiel sigelon sur via brako; Ĉar la amo estas forta kiel la morto;   La ĵaluzo estas nefleksebla kiel Ŝeol;   Ĝiaj brulaĵoj estas brulaĵoj de fajro,   La flamo de la Eternulo.",
