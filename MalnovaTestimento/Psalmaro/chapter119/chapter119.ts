export const chapter119 = {
  ...
  verses: [
    ...
    "BET. Per kio junulo povas purigi sian vojon? Per plenumado laŭ Viaj vortoj.",
    ...
    "DALET. Mia animo algluiĝis al la polvo; Vivigu min laŭ Via vorto.",
    ...
    "HE. Montru al mi, ho Eternulo, la vojon de Viaj leĝoj, Kaj mi ĝin sekvos ĝis la fino.",
    ...
    "ĥET. Mi diris:Mia sortaĵo estas, ho Eternulo, Plenumi Viajn vortojn.",
    ...
    "LAMED. Por eterne, ho Eternulo, Via vorto staras forte en la ĉielo.",
    ...
    "SAMEĥ. Skeptikulojn mi malamas, Sed Vian instruon mi amas.",
    ...
    "CADI. Justulo Vi estas, ho Eternulo, Kaj justaj estas Viaj juĝoj.",
    ...
    "KOF. Mi vokas el la tuta koro; aŭskultu min, ho Eternulo; Mi plenumos Viajn leĝojn.",
    ...
    "REŜ. Rigardu mian mizeron, kaj liberigu min, Ĉar Vian instruon mi ne forgesis.",
    ...
    "ŜIN. Princoj persekutas min senkaŭze; Sed Vian vorton timas mia koro.",
    ...
    "TAV. Mia krio venu al Vi, ho Eternulo; Laŭ Via vorto klerigu min.",
