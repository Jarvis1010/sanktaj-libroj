export const chapter23 = {
  ...
  verses: [
    ...
    "Kaj Abraham aŭskultis Efronon, kaj Abraham pesis al Efron la monon, pri kiu li parolis aŭdeble por la filoj de ĥet, kvarcent siklojn da arĝento, uzata en la komerco.",
