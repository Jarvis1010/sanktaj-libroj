export const chapter42 = {
  ...
  verses: [
    ...
    "Sed li diris: Mia filo ne iros kun vi; ĉar lia frato mortis, kaj li sola restis. Se lin trafos malfeliĉo sur la vojo, kiun vi iros, tiam vi enirigos miajn grizajn harojn kun malĝojo en Ŝeolon.",
  ],
