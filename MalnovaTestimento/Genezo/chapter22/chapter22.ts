export const chapter22 = {
  ...
  verses: [
    ...
    "Kaj Abraham levis siajn okulojn, kaj vidis, ke jen virŝafo malantaŭe implikiĝis per la kornoj en la arbetaĵoj. Kaj Abraham iris kaj prenis la virŝafon, kaj oferis ĝin kiel bruloferon anstataŭ sia filo.",
