export const chapter20 = {
  ...
  verses: [
    ...
    "Kaj nun redonu la edzinon al la edzo, ĉar li estas profeto, kaj li preĝos pri vi, kaj vi restos viva; sed se vi ne redonos, tiam sciu, ke vi mortos, vi kaj ĉiuj viaj.",
