export const chapter37 = {
  ...
  verses: [
    ...
    "Kaj ĉiuj liaj filoj kaj filinoj penis konsoli lin, sed li ne volis konsoliĝi, kaj diris: En funebro mi iros en Ŝeolon al mia filo. Tiel ploris pri li lia patro.",
