export const chapter8 = {
  ...
  verses: [
    ...
    "Tiam mi sendis Eliezeron, Arielon, Ŝemajan, Elnatanon, Jaribon, Elnatanon, Natanon, Zeĥarjan, kaj Meŝulamon, la ĉefojn, kaj Jojaribon kaj Elnatanon, la scienculojn;",
    "kaj mi donis al ili komision al Ido, la ĉefo en la loko Kasifja, kaj mi donis al ili instrukcion pri tio, kion ili devas diri al Ido, kaj al liaj fratoj, la Netinoj, en la loko Kasifja, por venigi al ni servistojn por la domo de nia Dio.",
    ...
    "Ĉar mi hontis peti de la reĝo militistojn kaj rajdistojn por defendi nin kontraŭ malamikoj sur la vojo; ĉar ni tiele diris al la reĝo:La mano de nia Dio estas bonfaranta por ĉiuj, kiuj sin turnas al Li, kaj Lia potenco kaj Lia kolero estas kontraŭ ĉiuj, kiuj Lin forlasas.",
    ...
    "Kaj la pastroj kaj la Levidoj akceptis la pesitajn arĝenton, oron, kaj vazojn, por forporti en Jerusalemon en la domon de nia Dio.",
    ...
    "En la kvara tago la arĝento, oro, kaj vazoj estis transdonitaj pese en la domon de nia Dio, en la manojn de la pastro Meremot, filo de Urija, kune kun Eleazar, filo de Pineĥas, kune kun Jozabad, filo de Jeŝua, kaj Noadja, filo de Binuj, la Levidoj.",
    "Ĉio estis farita laŭnombre kaj laŭpeze, kaj ĉio pesita estis tiutempe enskribita.",
    "La forkaptitoj, kiuj revenis el la kaptiteco, alportis bruloferojn al Dio de Izrael:dek du bovojn, pro la tuta Izrael, naŭdek ses ŝafojn, sepdek sep ŝafidojn, dek du pekoferajn kaprojn, ĉion kiel bruloferon al la Eternulo.",
