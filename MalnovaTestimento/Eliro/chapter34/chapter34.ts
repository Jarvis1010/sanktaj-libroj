export const chapter34 = {
  ...
  verses: [
    ...
    "kiu konservas favorkorecon por miloj, pardonas kulpon kaj krimon kaj pekon, sed antaŭ kiu neniu estas senkulpa; kiu punas la kulpon de patroj sur filoj kaj nepoj, en la tria kaj kvara generacioj!",
    "Kaj rapide Moseo kliniĝis ĝis la tero kaj faris adoron.",
    "Kaj li diris:Ho, se mi akiris Vian favoron, mia Sinjoro, tiam mia Sinjoro volu iri en nia mezo, ĉar tio estas popolo malmolnuka; kaj pardonu niajn kulpojn kaj niajn pekojn kaj faru nin Via posedaĵo.",
    "Kaj Li diris:Jen Mi faros interligon; antaŭ via tuta popolo Mi faros miraklojn, kiuj neniam ekzistis sur la tuta tero nek ĉe iuj gentoj; kaj la tuta popolo, en kies mezo vi estas, vidos la faron de la Eternulo; ĉar terura estos tio, kion Mi faros por vi.",
    ...
    "Ne faru interligon kun la loĝantoj de la lando; ĉar, malĉastante kun siaj dioj kaj alportante oferojn al siaj dioj, ili eble vokos vin kaj vi manĝos de iliaj oferoj,",
    ...
    "Ĉar Mi forpelos gentojn antaŭ vi kaj vastigos viajn limojn, kaj neniu deziros havi vian landon, kiam vi iros, por montriĝi antaŭ la Eternulo, via Dio, tri fojojn en la jaro.",
    ...
    "Kiam Moseo estis malsupreniranta de la monto Sinaj kaj la du tabeloj de atesto estis en la manoj de Moseo dum lia malsuprenirado de la monto, Moseo ne sciis, ke la haŭto de lia vizaĝo lumradiis pro tio, ke li parolis kun Li.",
    ...
    "Kiam Moseo venadis antaŭ la Eternulon, por paroli kun Li, li formetadis la kovrotukon ĝis sia eliro; kaj elirinte, li diradis al la Izraelidoj tion, kio estis ordonita al li.",
