export const chapter39 = {
  ...
  verses: [
    ...
    "Kaj ili batetendis foliojn da oro kaj tranĉis ilin en formo de fadenoj, por enteksi internen de la blua, purpura, kaj ruĝa teksaĵo kaj de la bisino per artista laboro.",
    "Surŝultraĵojn kunigantajn ili faris al ĝi; sur siaj du finoj ĝi estis ligita.",
    "Kaj la ĉirkaŭliganta zono sur ĝi estis kontinuaĵo de ĝi, la sama laboraĵo, el oro, el blua, purpura, kaj ruĝa teksaĵo, kaj el tordita bisino; kiel la Eternulo ordonis al Moseo.",
    ...
    "Kaj ili alligis la surbrustaĵon per ĝiaj ringoj al la ringoj de la efodo per laĉo el blua ŝtofo, por ke ĝi estu super la zono de la efodo kaj por ke la surbrustaĵo ne forŝoviĝu de sur la efodo; kiel la Eternulo ordonis al Moseo.",
    ...
    "la kupran altaron kaj la kupran kradon por ĝi, ĝiajn stangojn kaj ĉiujn ĝiajn apartenaĵojn, la lavujon kaj ĝian piedestalon;",
