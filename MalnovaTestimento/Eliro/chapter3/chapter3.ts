export const chapter3 = {
  ...
  verses: [
    ...
    "Kaj Mi malsupreniris, por savi ĝin el la manoj de la Egiptoj kaj elirigi ĝin el tiu lando en landon bonan kaj vastan, en landon, en kiu fluas lakto kaj mielo, sur la lokon de la Kanaanidoj kaj la ĥetidoj kaj la Amoridoj kaj la Perizidoj kaj la ĥividoj kaj la Jebusidoj.",
    ...
    "Kaj plue Dio diris al Moseo:Tiel diru al la Izraelidoj:La Eternulo, la Dio de viaj patroj, la Dio de Abraham, la Dio de Isaak, kaj la Dio de Jakob, sendis min al vi. Tia estas Mia nomo por eterne, kaj tia estas memoraĵo pri Mi por ĉiuj generacioj.",
    ...
    "Kaj Mi diris:Mi elirigos vin el la mizero de Egiptujo en la landon de la Kanaanidoj kaj la ĥetidoj kaj la Amoridoj kaj la Perizidoj kaj la ĥividoj kaj la Jebusidoj, en landon, en kiu fluas lakto kaj mielo.",
