export const chapter3 = {
  ...
  verses: [
    ...
    "kaj ordonis al la popolo, dirante:Kiam vi ekvidos la keston de interligo de la Eternulo, via Dio, kaj la pastrojn Levidojn, kiuj portas ĝin, tiam ekmoviĝu de viaj lokoj kaj iru post ili.",
    ...
    "Kaj la Eternulo diris al Josuo:En ĉi tiu tago Mi komencos altigi vin antaŭ la okuloj de la tuta Izrael, por ke ili sciu, ke kiel Mi estis kun Moseo, tiel Mi estos kun vi.",
    ...
    "Kaj Josuo diris:Per tio vi ekscios, ke la vivanta Dio estas inter vi, kaj ke Li forpelos de antaŭ vi la Kanaanidojn kaj la ĥetidojn kaj la ĥividojn kaj la Perizidojn kaj la Girgaŝidojn kaj la Amoridojn kaj la Jebusidojn:",
