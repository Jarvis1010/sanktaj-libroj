export const chapter7 = {
  ...
  verses: [
    ...
    "Kaj la loĝantoj de Aj mortigis el ili tridek ses homojn, kaj persekutis ilin de la pordego ĝis Ŝebarim, kaj venkobatis ilin sur la deklivo de la monto; kaj malkuraĝiĝis la koro de la popolo kaj fariĝis kiel akvo.",
    "Tiam Josuo disŝiris siajn vestojn, kaj ĵetis sin vizaĝaltere antaŭ la keston de la Eternulo, restante tiel ĝis la vespero, li kaj la plejaĝuloj de Izrael; kaj ili ŝutis polvon sur siajn kapojn.",
    "Kaj Josuo diris:Ho, mia Sinjoro, Eternulo, kial Vi transirigis ĉi tiun popolon trans Jordanon, por transdoni nin en la manon de la Amoridoj, por pereigi nin? ho, kial ni ne restis sur tiu flanko de Jordan?",
    ...
    "Izrael pekis, kaj ili agis kontraŭ Mia interligo, kiun Mi donis al ili, kaj ili prenis el la anatemitaĵo, kaj ŝtelis, kaj mensoge neis, kaj metis inter siajn vazojn.",
    ...
    "Leviĝu, sanktigu la popolon, kaj diru:Sanktigu vin por morgaŭ; ĉar tiel diris la Eternulo, Dio de Izrael:Anatemitaĵo estas inter vi, Izrael; vi ne povos rezisti antaŭ viaj malamikoj, ĝis vi forigos la anatemitaĵon el inter vi.",
    ...
    "Kaj Josuo kune kun la tuta Izrael prenis Aĥanon, filon de Zeraĥ, kaj la arĝenton kaj la mantelon kaj la stangeton da oro, kaj liajn filojn kaj liajn filinojn, kaj liajn bovojn kaj liajn azenojn kaj liajn ŝafojn, kaj lian tendon, kaj ĉion, kio apartenis al li, kaj elkondukis ilin en la valon Aĥor.",
