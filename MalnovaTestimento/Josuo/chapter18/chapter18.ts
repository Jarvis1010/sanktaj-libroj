export const chapter18 = {
  ...
  verses: [
    ...
    "La Levidoj ne havos parton inter vi, ĉar la pastrado antaŭ la Eternulo estas ilia hereda parto; kaj Gad kaj Ruben kaj la duontribo de Manase prenis sian parton transe de Jordan, oriente, kion donis al ili Moseo, servanto de la Eternulo.",
    ...
    "Kaj la viroj foriris kaj trairis la landon kaj disskribis ĝin laŭ la urboj en sep partojn en libro, kaj revenis al Josuo en la tendaron, al Ŝilo.",
    ...
    "Kaj de tie la limo iras al Luz, al la suda flanko de Luz (tio estas Bet-El); kaj la limo plue iras al Atrot-Adar, sur la monton, kiu estas sude de la malsupra Bet-ĥoron.",
    ...
    "kaj Bet-Araba kaj Cemaraim kaj Bet-El",
    "kaj Avim kaj Para kaj Ofra",
