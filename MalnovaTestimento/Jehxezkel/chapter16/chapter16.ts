export const chapter16 = {
  ...
  verses: [
    ...
    "Mi grandigis vin, kiel kampan kreskaĵon; vi fariĝis plena kaj granda, vi fariĝis tute bela; viaj mamoj formiĝis, viaj haroj abunde kreskis; sed vi estis nuda kaj nekovrita.",
    ...
    "Vi ornamiĝis per oro kaj arĝento, viaj vestoj estis el bisino, silko, kaj broditaĵo; plej delikatan farunon, mielon, kaj oleon vi manĝis; kaj vi fariĝis tre kaj tre bela kaj atingis reĝecon.",
    ...
    "Vi prenis viajn vestojn kaj faris al vi mikskolorajn oferaltaĵojn, kaj sur ili vi malĉastis, kiel neniam estis kaj neniam estos.",
    ...
    "Tiele diras la Sinjoro, la Eternulo:Pro tio, ke vi malŝparas vian metalon kaj via nudeco estas malkovrata en via malĉastado al viaj amistoj kaj al ĉiuj viaj abomenindaj idoloj, kaj pro la sango de viaj infanoj, kiujn vi fordonas al ili-",
    "pro tio Mi kolektos ĉiujn viajn amistojn, kun kiuj vi ĝuis, kaj ĉiujn, kiujn vi amis, kaj ĉiujn, kiujn vi malamis, kaj Mi kolektos ilin kontraŭ vi de ĉirkaŭe, kaj Mi malkovros antaŭ ili vian nudecon, kaj ili vidos vian tutan hontindaĵon.",
    ...
    "Mi transdonos vin en iliajn manojn, kaj ili detruos vian malĉastejon kaj disbatos viajn fialtaĵojn, ili deprenos de vi viajn vestojn, prenos viajn ornamaĵojn, kaj restigos vin nuda kaj nekovrita.",
    ...
    "Pro tio, ke vi ne rememoris la tagojn de via juneco, sed incitis Min per ĉio tio, Mi ankaŭ metos vian konduton sur vian kapon, diras la Sinjoro, la Eternulo, por ke vi ne plu faru la malĉastaĵon kun ĉiuj viaj abomenindaĵoj.",
    ...
    "Jen kio estis la kulpo de via fratino Sodom:malmodesteco, trosatiĝo per manĝado, kaj senzorgeco, kiun havis ŝi kaj ŝiaj filinoj; kaj la manon de malriĉulo kaj senhavulo ŝi ne subtenis.",
    ...
    "Tial ankaŭ vi nun portu vian malhonoron, kiun vi kondamnis en viaj fratinoj, pro viaj pekoj, per kiuj vi abomenindiĝis pli ol ili; ili estas virtulinoj en komparo kun vi; hontu kaj portu vian malhonoron, ĉar vi kvazaŭ pravigis viajn fratinojn.",
    ...
    "Viaj fratinoj, Sodom kaj ŝiaj filinoj revenos al sia antaŭa stato, kaj Samario kaj ŝiaj filinoj revenos al sia antaŭa stato; ankaŭ vi kaj viaj filinoj revenos al via antaŭa stato.",
    "Ĉu via fratino Sodom ne estis objekto de rezonado en via buŝo en la tempo de via fiereco,",
    "antaŭ ol elmontriĝis via malboneco, kiel en la tempo de la malhonoro de la filinoj de Sirio kaj ĉiuj ĝiaj ĉirkaŭaĵoj, kaj de la filinoj de Filiŝtujo, kiuj malestimis vin ĉirkaŭe?",
