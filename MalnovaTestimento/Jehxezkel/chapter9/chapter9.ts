export const chapter9 = {
  ...
  verses: [
    ...
    "Kaj la majesto de Dio de Izrael leviĝis de la kerubo, sur kiu ĝi estis, al la sojlo de la domo. Kaj Li alvokis la homon, kiu estis vestita per tolo kaj havis skribilon ĉe siaj lumboj.",
    ...
    "Kiam ili finis la mortigadon kaj mi restis, tiam mi ĵetis min vizaĝaltere, ekkriis, kaj diris:Ho Sinjoro, ho Eternulo! ĉu Vi ekstermos la tutan restaĵon de Izrael, elverŝante Vian koleron sur Jerusalemon?",
    "Kaj Li diris al mi:La malpieco de la domo de Izrael kaj de Jehuda estas tre, tre granda, kaj la lando estas plena de sango, kaj la urbo estas plena de maljusteco; ĉar ili diras:La Eternulo forlasis la landon, kaj la Eternulo ne vidas.",
