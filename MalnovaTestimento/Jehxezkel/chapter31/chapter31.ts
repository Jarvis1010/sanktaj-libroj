export const chapter31 = {
  ...
  verses: [
    ...
    "Per la bruo de ĝia falo Mi ektremigos la naciojn, kiam Mi puŝos ĝin en Ŝeolon al tiuj, kiuj iris en la tombon; kaj konsoliĝos en la profundo subtera ĉiuj arboj de Eden, la plej elektitaj kaj plej bonaj de Lebanon, ĉiuj akvonutrataj.",
