export const chapter45 = {
  ...
  verses: [
    ...
    "Per tiu mezuro mezuru la longon de dudek kvin mil kaj la larĝon de dek mil; sur tiu loko estos la sanktejo, la plejsanktaĵo.",
    "La cetera parto de la sankta tero apartenu al la pastroj, kiuj servas en la sanktejo, kiuj alproksimiĝas al la Eternulo, por servi al Li; ĝi estu por ili kiel loko por domoj, kaj estu konsekrita al la sanktejo.",
    ...
    "Kaj kiel posedaĵon de la urbo apartigu kvin mil da larĝo kaj dudek kvin mil da longo kontraŭ la sankta terpeco:ĝi apartenu al la tuta domo de Izrael.",
    "Kaj al la princo donu parton ambaŭflanke apud la sankta terpeco kaj apud la urba posedaĵo, sur la okcidenta flanko okcidenten kaj sur la orienta flanko orienten; ĝia longo devas esti tia sama, kiel de unu el tiuj partoj de la okcidenta limo ĝis la orienta.",
    ...
    "Kaj la princo devas zorgi pri la bruloferoj, farunofero, kaj verŝofero en la festoj, monatkomencoj, kaj sabatoj, en ĉiuj festoj de la domo de Izrael; li devas alportadi la pekoferon, la farunoferon, la bruloferon, kaj la pacoferon, por atingi pekliberigon por la domo de Izrael.",
    ...
    "Kaj dum la sep tagoj de la festo li alportadu bruloferon al la Eternulo, po sep bovoj kaj po sep virŝafoj sendifektaj ĉiutage dum la sep tagoj, kaj po unu virkapro kiel pekoferon ĉiutage.",
