export const chapter19 = {
  ...
  verses: [
    ...
    "Kaj oni metis ĝin en ĉenoj en kaĝegon kaj forportis ĝin al la reĝo de Babel; kaj oni metis ĝin en fortikigitan lokon, por ke oni ne plu aŭdu ĝian voĉon sur la montoj de Izrael.",
