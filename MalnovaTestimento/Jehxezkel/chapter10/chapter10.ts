export const chapter10 = {
  ...
  verses: [
    ...
    "Kaj leviĝis la majesto de la Eternulo de la kerubo al la enirejo de la domo, kaj la domo pleniĝis de la nubo, kaj la korto pleniĝis de brilo de la majesto de la Eternulo.",
    ...
    "tiam unu el la keruboj etendis sian manon el inter la keruboj al la fajro, kiu estis inter la keruboj, kaj prenis kaj metis sur la manplatojn de la tolvestito; kaj ĉi tiu prenis kaj eliris.",
