export const chapter32 = {
  ...
  verses: [
    ...
    "Mi teruros pro vi multajn popolojn, kaj iliaj reĝoj ektremos pro vi, kiam Mi svingos Mian glavon antaŭ iliaj vizaĝoj, kaj ĉiu el ili ĉiuminute tremos pri sia vivo en la tago de via falo.",
    ...
    "Tio estas funebra kanto, kiun oni kantos; la filinoj de la nacioj ĝin kantos, pri Egiptujo kaj pri ĝia tuta grandnombra popolo ili ĝin kantos, diras la Sinjoro, la Eternulo.",
    ...
    "Tie estas Elam kaj ĝia tuta homomulto, ĉirkaŭe estas ĝiaj tomboj; ĉiuj ili estas mortigitoj, kiuj falis de glavo kaj necirkumcidite malsupreniris en la profundon subteran, la samaj, kiuj ĵetadis ĉirkaŭ si teruron sur la tero de la vivantoj; ili portis sian honton kune kun tiuj,  kiuj iris en la tombon.",
    "Meze de mortigitoj estas donita kuŝejo al ĝi kun ĝia tuta homomulto; ĉirkaŭe estas iliaj tomboj; ĉiuj ili estas necirkumciditaj, mortigitaj de glavo; ĉar ili ĵetadis ĉirkaŭ si teruron sur la tero de la vivantoj, tial ili portis sian honton kun tiuj, kiuj iris en la tombon, kaj ili estas metitaj inter la mortigitojn.",
    ...
    "Ili ne kuŝas kun la herooj, kiuj falis de necirkumciditoj kaj iris en Ŝeolon kun siaj bataliloj kaj metis siajn glavojn sub siajn kapojn; iliaj malbonagoj restis sur iliaj ostoj, ĉar kiel fortuloj ili ĵetadis ĉirkaŭ si teruron sur la tero de la vivantoj.",
    "Kaj vi ankaŭ estos frakasita meze de la necirkumciditoj, kaj kuŝos kun tiuj, kiuj estas mortigitaj de glavo.",
    "Tie estas Edom kun siaj reĝoj kaj kun ĉiuj siaj princoj, kiuj malgraŭ sia forteco estas ĵetitaj al tiuj, kiuj falis de glavo; ili kuŝas kun la necirkumciditoj, kaj kun tiuj, kiuj iris en la tombon.",
    "Tie estas ĉiuj princoj de la nordo, kaj ĉiuj Cidonanoj, kiuj malsupreniris kune kun la mortigitoj; ili hontas pri la teruro, kiun ĵetadis ilia forto; ili kuŝas necirkumciditaj kun tiuj, kiuj falis de glavo, kaj ili portas sian honton kun tiuj, kiuj iris en la tombon.",
