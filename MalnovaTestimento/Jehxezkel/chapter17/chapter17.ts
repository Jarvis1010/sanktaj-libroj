export const chapter17 = {
  ...
  verses: [
    ...
    "Kaj estis alia granda aglo kun grandaj flugiloj kaj abundaj plumoj; kaj jen tiu vinbertrunko tiris sin per siaj radikoj al ĝi kaj etendis al ĝi siajn branĉojn, por ke ĝi trinkigu ĝin, de la bedoj, kie ĝi estis plantita.",
    ...
    "Diru:Tiele diras la Sinjoro, la Eternulo:Ĉu ĝi havos sukceson? oni ja elŝiros ĝiajn radikojn, oni deŝiros ĝiajn fruktojn, kaj ĝi velkos; ĉiuj ĝiaj elkreskintaj folioj velkos, kaj oni ne bezonos grandan forton kaj multon da homoj, por deŝiri ĝin de ĝiaj radikoj.",
    ...
    "Kaj aperis al mi vorto de la Eternulo, dirante:",
    "Diru do al la domo malobeema:Ĉu vi ne scias, kion tio signifas? Diru:Jen venis la reĝo de Babel en Jerusalemon, kaj prenis ĝian reĝon kaj ĝiajn eminentulojn kaj venigis ilin al si en Babelon;",
    ...
    "Sed tiu defalis de li, kaj sendis siajn senditojn en Egiptujon, por ke oni donu al li ĉevalojn kaj multe da homoj. Ĉu li povas havi sukceson? ĉu povas saviĝi tiu, kiu tiel agas? ĉu li saviĝos, se li rompis la interligon?",
    "Kiel Mi vivas, diras la Sinjoro, la Eternulo, sur la loko de tiu reĝo, kiu faris lin reĝo kaj antaŭ kiu li malŝatis sian ĵuron kaj rompis lian interligon, ĉe li, en Babel, li mortos.",
    "Kaj Faraono kun granda forto kaj multenombra anaro ne helpos al li en la milito, kiam estos surŝutitaj remparoj kaj estos konstruitaj bastionoj, por ekstermi multe da homoj.",
    ...
    "Tiele diras la Sinjoro, la Eternulo:Mi mem prenos branĉon de alta cedro kaj metos ĝin; el la supraj junaj branĉetoj Mi deŝiros la plej delikatan, kaj Mi plantos ĝin sur monto alta kaj eminenta.",
    "Sur la alta monto de Izrael Mi ĝin plantos, kaj ĝi elkreskigos branĉojn kaj donos fruktojn kaj fariĝos belega cedro; kaj loĝos sub ĝi ĉiaspecaj birdoj, ĉiaspecaj flugiluloj nestos en la ombro de ĝiaj branĉoj.",
    "Kaj ekscios ĉiuj arboj de la kampo, ke Mi, la Eternulo, malaltigas arbon altan kaj altigas arbon malaltan, ke Mi velkigas arbon sukoplenan kaj verdigas arbon velkintan; Mi, la Eternulo, tion diris, kaj Mi tion plenumos.",
  ],
