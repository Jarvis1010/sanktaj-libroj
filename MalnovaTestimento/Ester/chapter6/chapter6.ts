export const chapter6 = {
  ...
  verses: [
    ...
    "Haman eniris. Kaj la reĝo diris al li:Kion oni faru al tiu homo, kiun la reĝo deziras honori? Haman pensis en sia koro:Al kiu la reĝo povas deziri fari honoron krom mi?",
    ...
    "oni donu la veston kaj la ĉevalon en la manon de unu el la plej eminentaj reĝaj princoj, ke oni vestu la homon, kiun la reĝo deziras honori, kaj rajdigu lin sur la ĉevalo sur la strato de la urbo, kaj oni proklamadu antaŭ li:Tiele estas farate al la homo, kiun la reĝo volas honori.",
    "Tiam la reĝo diris al Haman:Rapide prenu la veston kaj la ĉevalon, kiel vi diris, kaj agu tiel kun la Judo Mordeĥaj, kiu sidas ĉe la pordego de la reĝo; mankigu nenion el ĉio, kion vi diris.",
    ...
    "Haman rakontis al sia edzino Zereŝ kaj al ĉiuj siaj amikoj ĉion, kio okazis al li. Kaj diris al li liaj saĝuloj kaj lia edzino Zereŝ:Se el la gento de la Judoj estas Mordeĥaj, antaŭ kiu vi komencis fali, vi nenion povas fari kontraŭ li, sed vi plue falos antaŭ li.",
