export const chapter19 = {
  ...
  verses: [
    ...
    "Sed la eminentuloj de la Amonidoj diris al ĥanun:Ĉu efektive David deziras honori vian patron antaŭ vi, ke li sendis al vi konsolantojn? ĉu ne venis al vi liaj servantoj nur por esplori, por ruinigi, kaj por esplorrigardi la landon?",
    ...
    "Kaj ili iris. Kaj oni raportis al David pri tiuj viroj, kaj li sendis renkonte al ili, ĉar la viroj tre hontis. Kaj la reĝo diris:Restu en JeriĤo, ĝis rekreskos viaj barboj, kaj tiam revenu.",
    "Kiam la Amonidoj vidis, ke ili indignigis kontraŭ si Davidon, tiam ĥanun kaj la Amonidoj sendis mil kikarojn da arĝento, por dungi al si el Mezopotamio, el Sirio de MaaĤa, kaj el Coba ĉarojn kaj rajdistojn.",
    ...
    "Kiam tio estis raportita al David, li kolektis ĉiujn Izraelidojn, transiris Jordanon, venis al ili, kaj batalaranĝiĝis kontraŭ ili; David aranĝis batalon kontraŭ la Sirianoj, kaj ili interbatalis kun li.",
    ...
    "Kiam la servantoj de Hadarezer vidis, ke ili estas venkobatitaj de la Izraelidoj, ili faris pacon kun David kaj submetiĝis al li. Kaj la Sirianoj ne volis plu helpi al la Amonidoj.",
  ],
