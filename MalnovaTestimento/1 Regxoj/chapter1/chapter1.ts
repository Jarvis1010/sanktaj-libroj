export const chapter1 = {
  ...
  verses: [
    ...
    "Dume Adonija, filo de ĥagit, fieriĝis, kaj diris:Mi fariĝos reĝo. Kaj li havigis al si ĉarojn kaj rajdistojn kaj kvindek homojn por kuradi antaŭ li.",
    "Kaj lia patro neniam afliktis lin per demando:Kial vi tion faras? Krom tio li estis tre belaspekta, kaj li estis naskita post Abŝalom.",
    "Kaj li interkonsentis kun Joab, filo de Ceruja, kaj kun la pastro Ebjatar, kaj ili helpadis Adonijan.",
    "Sed la pastro Cadok, kaj Benaja, filo de Jehojada, kaj la profeto Natan kaj Ŝimei kaj Rei kaj la fortuloj de David ne estis kun Adonija.",
    "Adonija buĉis ŝafojn kaj bovojn kaj grasigitajn brutojn ĉe la ŝtono ZoĤelet, kiu kuŝas apud En-Rogel; kaj li invitis ĉiujn siajn fratojn, la filojn de la reĝo, kaj ĉiujn Jehudaanojn, kiuj servis al la reĝo.",
    "Sed la profeton Natan kaj Benajan kaj la fortulojn kaj sian fraton Salomono li ne invitis.",
    "Kaj Natan diris al Bat-Ŝeba, patrino de Salomono, jene:Ĉu vi ne aŭdis, ke Adonija, filo de ĥagit, fariĝis reĝo, kaj nia sinjoro David tion ne scias?",
    "Venu do, mi donos al vi konsilon, por ke vi savu vian animon kaj la animon de via filo Salomono.",
    "Iru kaj venu al la reĝo David, kaj diru al li:Mia sinjoro, ho reĝo, vi ĵuris ja al via servantino, dirante:Via filo Salomono reĝos post mi, kaj li sidos sur mia trono; kial do Adonija fariĝis reĝo?",
    "Dum vi ankoraŭ estos parolanta tie kun la reĝo, mi venos post vi kaj kompletigos viajn vortojn.",
    "Kaj Bat-Ŝeba venis al la reĝo en la ĉambron; la reĝo estis tre maljuna, kaj la Ŝunemanino Abiŝag servis al la reĝo.",
    ...
    "Li buĉis multe da bovoj kaj grasigitaj brutoj kaj ŝafoj, kaj invitis ĉiujn filojn de la reĝo kaj la pastron Ebjatar kaj la militestron Joab, sed vian servanton Salomono li ne invitis.",
    ...
    "Ĉar li iris hodiaŭ kaj buĉis multe da bovoj kaj grasigitaj brutoj kaj ŝafoj, kaj invitis ĉiujn filojn de la reĝo kaj la militestron kaj la pastron Ebjatar; kaj jen ili manĝas kaj trinkas antaŭ li, kaj proklamas:Vivu la reĝo Adonija!",
    "Sed min, vian servanton, kaj la pastron Cadok, kaj Benajan, filon de Jehojada, kaj vian servanton Salomono li ne invitis.",
    "Ĉu laŭ ordono de mia sinjoro la reĝo tio fariĝis, kaj vi ne sciigis al via servanto, kiu sidos sur la trono de mia sinjoro la reĝo post li?",
    ...
    "kiel mi ĵuris al vi per la Eternulo, Dio de Izrael, dirante:Via filo Salomono reĝos post mi kaj li sidos sur mia trono anstataŭ mi-tiel mi faros hodiaŭ.",
    ...
    "Kaj iris la pastro Cadok kaj la profeto Natan, kaj Benaja, filo de Jehojada, kaj la Keretidoj kaj la Peletidoj, kaj ili rajdigis Salomonon sur la mulo de la reĝo David kaj kondukis lin en GiĤonon.",
    ...
    "Tion aŭdis Adonija, kaj ĉiuj invititoj, kiuj estis kun li; ili jam finis la manĝadon; kaj aŭdis Joab la sonadon de la trumpeto, kaj li diris:Kion signifas la tumulta bruo de la urbo?",
    ...
    "kaj la reĝo sendis kun li la pastron Cadok kaj la profeton Natan, kaj Benajan, filon de Jehojada, kaj la Keretidojn kaj la Peletidojn, kaj ili rajdigis lin sur la mulo de la reĝo;",
    ...
    "Kaj jam venis la servantoj de la reĝo, por gratuli nian sinjoron, la reĝon David, dirante:Via Dio faru la nomon de Salomono pli fama, ol via nomo, kaj Li faru lian tronon pri granda, ol via trono; kaj la reĝo adorkliniĝis sur la kuŝejo.",
    "Kaj ankaŭ tiele diris la reĝo:Benata estu la Eternulo, Dio de Izrael, kiu donis hodiaŭ sidanton sur mia trono, kaj miaj okuloj vidas.",
    ...
    "Kaj oni raportis al Salomono jene:Jen Adonija timas la reĝon Salomono, kaj li tenas la kornojn de la altaro, dirante:La reĝo Salomono ĵuru al mi hodiaŭ, ke li ne mortigos sian servanton per glavo.",
    "Kaj Salomono diris:Se li estos homo brava, tiam eĉ unu el liaj haroj ne falos teren; sed se en li troviĝos malbono, tiam li mortos.",
