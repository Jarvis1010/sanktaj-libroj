export const chapter8 = {
  ...
  verses: [
    ...
    "Kaj kolektiĝis al la reĝo Salomono ĉiuj Izraelidoj al la festo, en la monato Etanim, tio estas la sepa monato.",
    ...
    "Kaj la stangoj estis tiel longaj, ke la kapetoj de la stangoj estis videblaj el la sankta loko en la antaŭa parto de la plejsanktejo, sed ekstere ili ne estis videblaj; kaj ili restis tie ĝis la nuna tago.",
    "En la kesto estis nenio krom la du ŝtonaj tabeloj, kiujn metis tien Moseo sur ĥoreb, kiam la Eternulo faris interligon kun la Izraelidoj post ilia eliro el la lando Egipta.",
    "Kiam la pastroj eliris el la sanktejo, nubo plenigis la domon de la Eternulo.",
    "Kaj la pastroj ne povis stari kaj servi, pro la nubo; ĉar la majesto de la Eternulo plenigis la domon de la Eternulo.",
    ...
    "Kaj li diris:Benata estu la Eternulo, Dio de Izrael, kiu parolis per Sia buŝo al mia patro David, kaj nun plenumis per Sia mano, dirante:",
    "De post la tago, kiam Mi elkondukis Mian popolon Izrael el Egiptujo, Mi elektis neniun urbon inter ĉiuj triboj de Izrael, por konstrui domon, en kiu estus Mia nomo; sed Mi elektis Davidon, ke li estu super Mia popolo Izrael.",
    ...
    "Kaj la Eternulo plenumis Sian vorton, kiun Li diris:mi leviĝis anstataŭ mia patro David kaj sidiĝis sur la trono de Izrael, kiel diris la Eternulo, kaj mi konstruis la domon al la nomo de la Eternulo, Dio de Izrael.",
    "Kaj mi aranĝis tie lokon por la kesto, en kiu troviĝas la interligo de la Eternulo, kiun Li faris kun niaj patroj, kiam Li elkondukis ilin el la lando Egipta.",
    ...
    "Vi plenumis al Via servanto David, mia patro, kion Vi promesis al li; Vi parolis per Via buŝo, kaj Vi plenumis per Via mano, kiel ni nun vidas.",
    "Nun, ho Eternulo, Dio de Izrael, plenumu al Via servanto David, mia patro, kion Vi promesis al li, dirante:Ne mankos ĉe vi antaŭ Mi viro, sidanta sur la trono de Izrael, se viaj filoj nur observados sian vojon, por iradi antaŭ Mi, kiel vi iradis antaŭ Mi.",
    ...
    "por ke Viaj okuloj estu nefermitaj super ĉi tiu domo nokte kaj tage, super la loko, pri kiu Vi diris:Mia nomo tie estos; por aŭskulti la preĝon,  kiun Via servanto faros sur ĉi tiu loko.",
    "Kaj aŭskultu la petegon de Via servanto kaj de Via popolo Izrael, kiun ili preĝos sur ĉi tiu loko; aŭskultu sur la loko de Via loĝado en la ĉielo; kaj kiam Vi aŭskultos, Vi pardonu.",
    ...
    "Se Via popolo Izrael estos frapita de malamiko pro tio, ke ĝi pekis antaŭ Vi, sed ili sin returnos al Vi kaj gloros Vian nomon kaj preĝos kaj petegos al Vi en ĉi tiu domo:",
    ...
    "Se la ĉielo ŝlosiĝos tiel, ke ne estos pluvo pro tio, ke ili pekis antaŭ Vi, sed ili ekpreĝos sur ĉi tiu loko kaj gloros Vian nomon kaj returnos sin de sia peko, por ke Vi aŭskultu ilin:",
    "tiam aŭskultu en la ĉielo, kaj pardonu la pekon de Viaj servantoj kaj de Via popolo Izrael, montrante al ili la bonan vojon, kiun ili devas iri, kaj donu pluvon sur Vian landon, kiun Vi donis al Via popolo kiel heredaĵon.",
    ...
    "ĉe ĉiu preĝo, ĉe ĉiu petego, kiu venos de iu homo aŭ de Via tuta popolo Izrael, kiam ĉiu el ili sentos malfeliĉon en sia koro kaj etendos siajn manojn al ĉi tiu domo:",
    "Vi aŭskultu en la ĉielo, en la loko de Via loĝado, kaj pardonu, kaj faru kaj redonu al ĉiu konforme al lia tuta konduto, kiel Vi konas lian koron (ĉar Vi sola konas la koron de ĉiuj homidoj);",
    ...
    "Vi aŭskultu en la ĉielo, en la loko de Via loĝado, kaj faru ĉion, pri kio vokos al Vi la aligentulo; por ke ĉiuj popoloj de la tero konu Vian nomon, por ke ili timu Vin, kiel Via popolo Izrael, kaj por ke ili sciu, ke per Via nomo estas nomata ĉi tiu domo, kiun mi konstruis.",
    "Kiam Via popolo eliros milite kontraŭ sian malamikon laŭ la vojo, laŭ kiu Vi ilin sendos, kaj ili preĝos al la Eternulo, turninte sin al la urbo, kiun Vi elektis, kaj al la domo, kiun mi konstruis al Via nomo:",
    "tiam aŭskultu en la ĉielo ilian preĝon kaj ilian petegon, kaj defendu ilian aferon.",
    "Se ili pekos antaŭ Vi (ĉar ne ekzistas homo, kiu ne pekas), kaj Vi ekkoleros kontraŭ ili kaj transdonos ilin al malamiko, kaj iliaj kaptintoj forkondukos ilin en landon malamikan, malproksiman aŭ proksiman;",
    "sed ili rekonsciiĝos en la lando, en kiu ili estos kaptitaj, konvertiĝos, kaj petegos Vin en la lando de siaj kaptintoj, dirante:Ni pekis, ni malbonagis, ni krimis;",
    "kaj ili returnos sin al Vi per sia tuta koro kaj per sia tuta animo en la lando de siaj malamikoj, kiuj ilin kaptis, kaj ili preĝos al Vi, turninte sin al sia lando, kiun Vi donis al iliaj patroj, al la urbo, kiun Vi elektis, kaj al la domo, kiun mi konstruis al Via nomo:",
    ...
    "Ĉar Vi distingis ilin kiel Vian heredaĵon el ĉiuj popoloj de la tero, kiel Vi diris per Via servanto Moseo, kiam Vi elkondukis niajn patrojn el Egiptujo, ho Sinjoro, Eternulo.",
    ...
    "Kaj ĉi tiuj miaj vortoj, kiujn mi preĝis antaŭ la Eternulo, estu proksimaj al la Eternulo, nia Dio, tage kaj nokte, por ke Li faru justaĵon al Sia servanto kaj justaĵon al Sia popolo Izrael en ĉiuj tagoj;",
    "por ke ĉiuj popoloj de la tero sciu, ke la Eternulo estas Dio kaj ke ne ekzistas alia.",
    "Via koro estu tute sindona al la Eternulo, nia Dio, por iri laŭ Liaj leĝoj kaj por observi Liajn ordonojn, kiel hodiaŭ.",
    ...
    "En tiu tago la reĝo sanktigis la mezon de la korto, kiu estis antaŭ la domo de la Eternulo; ĉar li faris tie la bruloferon kaj la farunoferon kaj alportis ofere la sebon de la pacoferoj; ĉar la kupra altaro, kiu estis antaŭ la Eternulo, estis tro malgranda, por doni lokon al la brulofero kaj la farunofero kaj la sebo de la pacoferoj.",
    "Kaj Salomono faris tiam feston, kaj kun li la tuta Izrael, tre granda anaro, kiu kunvenis de ĥamat ĝis la torento de Egiptujo, antaŭ la Eternulo, nia Dio, dum sep tagoj kaj ankoraŭ sep tagoj, kune dek kvar tagoj.",
    "En la oka tago li forsendis la popolon; kaj ili benis la reĝon, kaj iris al siaj tendoj, gajaj kaj ĝojantaj pro la tuta bono, kiun la Eternulo faris al Sia servanto David kaj al Sia popolo Izrael.",
  ],
