export const chapter18 = {
  ...
  verses: [
    ...
    "Kaj Aĥab diris al Obadja:Iru tra la lando al ĉiuj akvaj fontoj kaj al ĉiuj torentoj; eble ni trovos herbon, por ke ni povu konservi la vivon al la ĉevaloj kaj muloj kaj ne ekstermiĝu al ni ĉiuj brutoj.",
    ...
    "Kiel vivas la Eternulo, via Dio, ne ekzistas popolo aŭ regno, kien mia sinjoro ne estus sendinta min, por serĉi vin; kaj kiam ili diris, ke vi tie ne estas, li ĵurigis tiun regnon kaj popolon, ke oni ne trovis vin.",
    "Kaj nun vi diras:Iru, diru al via sinjoro, ke Elija estas ĉi tie.",
    "Kaj okazos, ke kiam mi foriros de vi, la spirito de la Eternulo forportos vin, mi ne scias kien; mi venos, por diri al Aĥab, kaj li ne trovos vin, kaj tiam li mortigos min; kaj via servanto estas diotima de sia juneco.",
    "Ĉu oni ne rakontis al mia sinjoro, kion mi faris, kiam Izebel mortigis la profetojn de la Eternulo, ke mi kaŝis cent homojn el la profetoj de la Eternulo en kavernoj po kvindek homoj kaj nutradis ilin per pano kaj akvo?",
    ...
    "Kaj nun sendu, kunvenigu al mi la tutan Izraelon sur la monton Karmel, ankaŭ la kvarcent kvindek profetojn de Baal kaj la kvarcent profetojn de Aŝtar, kiuj estas nutrataj ĉe la tablo de Izebel.",
    "Kaj Aĥab sendis al ĉiuj Izraelidoj, kaj li kunvenigis la profetojn sur la monton Karmel.",
    "Tiam Elija aliris al la tuta popolo, kaj diris:Kiel longe ankoraŭ vi lamos sur du flankoj? se la Eternulo estas Dio, sekvu Lin; kaj se Baal, tiam sekvu lin. Kaj la popolo nenion respondis al li.",
    ...
    "Oni donu do al ni du bovojn; kaj ili elektu al si unu el la bovoj kaj dishaku ĝin kaj metu sur la lignon, sed fajron ili ne submetu; kaj mi pretigos la duan bovon kaj metos sur la lignon, kaj fajron mi ne submetos.",
    ...
    "Kaj ili prenis la bovon, kiun li donis al ili, kaj pretigis, kaj vokadis al la nomo de Baal de la mateno ĝis la tagmezo, dirante:Ho Baal, aŭskultu nin! Sed aperis nenia voĉo nek respondo. Kaj ili saltadis ĉirkaŭ la altaro, kiun ili faris.",
    "Kiam fariĝis tagmezo, Elija mokis ilin, kaj diris:Kriu per laŭta voĉo, ĉar li estas dio; eble li havas interparoladon, aŭ eble li foriris, aŭ eble li vojaĝas; eble li dormas, li do vekiĝos.",
    ...
    "Kaj kiam venis la tempo, kiam oni faras farunoferon, la profeto Elija aliris, kaj diris:Ho Eternulo, Dio de Abraham, Isaak, kaj Izrael! hodiaŭ oni eksciu, ke Vi estas Dio ĉe Izrael kaj mi estas Via servanto, kaj ke laŭ Via vorto mi faris ĉion ĉi tion.",
    ...
    "En la sepa fojo tiu diris:Jen malgranda nubo, kiel manplato de homo, leviĝas de la maro. Tiam li diris:Iru, diru al Aĥab:Jungu kaj forveturu,  por ke vin ne retenu la pluvo.",
