export const chapter22 = {
  ...
  verses: [
    ...
    "La reĝo de Izrael diris al siaj servantoj:Ĉu vi scias, ke Ramot en Gilead apartenas al ni? kaj ni ne zorgas preni ĝin el la manoj de la reĝo de Sirio!",
    ...
    "Tiam la reĝo de Izrael kunvenigis la profetojn, ĉirkaŭe kvarcent homojn, kaj diris al ili:Ĉu mi iru milite kontraŭ Ramoton en Gilead, aŭ mi tion ne faru? Kaj ili respondis:Iru, la Sinjoro ĝin transdonos en la manon de la reĝo.",
    "Sed Jehoŝafat diris:Ĉu ne troviĝas ĉi tie ankoraŭ iu profeto de la Eternulo, kiun ni povus demandi?",
    "Kaj la reĝo de Izrael diris al Jehoŝafat:Ekzistas ankoraŭ unu homo, per kiu ni povas demandi la Eternulon, sed mi lin malamas, ĉar li profetas pri mi ne bonon, sed nur malbonon; tio estas MiĤaja, filo de Jimla. Sed Jehoŝafat diris:La reĝo ne parolu tiel.",
    "Tiam la reĝo de Izrael alvokis unu korteganon, kaj diris:Venigu rapide MiĤajan, filon de Jimla.",
    "La reĝo de Izrael, kaj Jehoŝafat, reĝo de Judujo, sidis ĉiu sur sia seĝo, vestitaj per siaj vestoj, sur placo antaŭ la pordego de Samario, kaj ĉiuj profetoj profetadis antaŭ ili.",
    ...
    "Kaj ĉiuj profetoj profetis tiel same, dirante:Iru kontraŭ Ramoton en Gilead kaj sukcesu, kaj la Eternulo ĝin transdonos en la manon de la reĝo.",
    ...
    "Kaj kiam li venis al la reĝo, la reĝo diris al li:MiĤaja! ĉu ni iru milite kontraŭ Ramoton en Gilead, aŭ ni tion ne faru? Kaj tiu respondis al li:Iru kaj sukcesu, kaj la Eternulo ĝin transdonos en la manon de la reĝo.",
    ...
    "Kaj la Eternulo diris:Kiu allogos AĤabon, ke li iru kaj falu en Ramot en Gilead? Kaj unu parolis tiel, alia parolis alie.",
    "Tiam eliris spirito kaj stariĝis antaŭ la Eternulo, kaj diris:Mi lin allogos. Kaj la Eternulo diris al li:Per kio?",
    "Kaj tiu diris:Mi eliros kaj faros min spirito mensoga en la buŝo de ĉiuj liaj profetoj. Tiam Li diris:Vi allogos kaj havos sukceson; eliru kaj agu tiel.",
    ...
    "La reĝo de Sirio ordonis al la tridek du ĉarestroj, kiuj estis ĉe li, dirante:Batalu ne kontraŭ iu malgranda aŭ granda, sed sole nur kontraŭ la reĝo de Izrael.",
    ...
    "La cetera historio de AĤab, kaj ĉio, kion li faris, kaj la ebura domo, kiun li konstruis, kaj ĉiuj urboj, kiujn li konstruis, estas priskribitaj en la libro de kroniko de la reĝoj de Izrael.",
    ...
    "Jehoŝafat havis la aĝon de tridek kvin jaroj, kiam li fariĝis reĝo, kaj dudek kvin jarojn li reĝis en Jerusalem. La nomo de lia patrino estis Azuba, filino de ŜilĤi.",
