export const chapter4 = {
  ...
  verses: [
    ...
    "kaj ĉu Mi povus ne domaĝi Nineven, la grandan urbon, en kiu troviĝas pli ol cent dudek mil homoj, ne povantaj distingi inter sia dekstra mano kaj sia maldekstra, kaj krom tio multe da brutoj?",
  ],
