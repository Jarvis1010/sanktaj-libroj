export const chapter1 = {
  ...
  verses: [
    ...
    "Sed Jona leviĝis, por forkuri de antaŭ la Eternulo en Tarŝiŝon; li iris en Jafon, trovis ŝipon, forirontan al Tarŝiŝ, pagis pro la vojaĝo, kaj eniris en ĝin, por veturi kun ili al Tarŝiŝ, for de la Eternulo.",
