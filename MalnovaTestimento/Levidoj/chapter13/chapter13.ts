export const chapter13 = {
  ...
  verses: [
    ...
    "Kaj la pastro rigardos la infektaĵon sur la haŭto de la korpo, kaj se li vidos, ke la haroj sur la infektaĵo fariĝis blankaj kaj la infektaĵo aspektas pli profunda ol la haŭto de lia korpo, tiam ĝi estas infektaĵo de lepro; kaj la pastro ĝin pririgardos, kaj deklaros, ke ĝi estas malpura.",
    "Kaj se ĝi estos blanka makulo sur la haŭto de lia korpo, sed ĝi ne aspektos pli profunda ol la haŭto, kaj la haroj sur ĝi ne fariĝis blankaj, tiam la pastro enŝlosu la infektiton por sep tagoj.",
    ...
    "Se la lepro disfloros sur la haŭto kaj la lepro kovros la tutan haŭton de la infektito, de lia kapo ĝis la piedoj, ĉion, kion povas vidi la okuloj de la pastro;",
    "kaj la pastro vidos, ke la lepro kovris lian tutan korpon, tiam li deklaros la infektaĵon pura:ĉio fariĝis blanka, tial ĝi estas pura.",
    ...
    "Kaj se la pastro vidos, ke ne estas sur ĝi blankaj haroj kaj ĝi ne estas pli profunda ol la haŭto kaj ĝi estas ne tre rimarkebla, tiam la pastro enŝlosos lin por sep tagoj.",
    ...
    "kaj la pastro ĝin rigardos, kaj vidos, ke la haroj sur la makulo fariĝis blankaj kaj ĝi aspektas pli profunda ol la haŭto, tiam ĝi estas lepro, kiu ekfloris sur la brulvundo; kaj la pastro deklaros ĝin malpura:ĝi estas infektaĵo de lepro.",
    ...
    "Kaj la pastro rigardos la favulon en la sepa tago, kaj se li vidos, ke la favo ne disvastiĝis sur la haŭto kaj ĝi ne aspektas pli profunda ol la haŭto, tiam la pastro deklaros lin pura; kaj li lavu siajn vestojn, kaj li estos pura.",
    ...
    "Kaj li rigardos la infektitaĵon en la sepa tago; se li vidos, ke la infektaĵo disvastiĝis sur la vesto, aŭ sur la fundamentaĵo, aŭ sur la enteksitaĵo, aŭ sur ia felaĵo, tiam la infektaĵo estas lepro pereiga; ĝi estas malpura.",
    ...
    "Kaj la pastro rigardos la infektaĵon post la lavo, kaj se li vidos, ke la infektaĵo ne ŝanĝis sian aspekton kaj la infektaĵo ne disvastiĝis, tiam ĝi estas malpura, per fajro oni ĝin forbruligu; ĝi estas penetriĝintaĵo sur la antaŭa aŭ malantaŭa flanko.",
    ...
    "Tio estas la leĝo pri la infektaĵo de lepro sur vesto lana aŭ lina, ĉu sur fundamentaĵo, ĉu sur enteksitaĵo, aŭ sur ia felaĵo, por deklari ĝin pura aŭ malpura.",
  ],
