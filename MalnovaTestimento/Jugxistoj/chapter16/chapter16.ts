export const chapter16 = {
  ...
  verses: [
    ...
    "Ŝimŝon kuŝis ĝis noktomezo; je noktomezo li leviĝis kaj kaptis la pordojn de la urba pordego kune kun ambaŭ fostoj kaj levis ilin kune kun la riglilo kaj metis sur siajn ŝultrojn, kaj forportis ilin sur la supron de la monto, kiu estas antaŭ ĥebron.",
    "Post tio li ekamis virinon en la valo Sorek; ŝia nomo estis Delila.",
    "Kaj venis al ŝi la estroj de la Filiŝtoj, kaj diris al ŝi:Allogu lin, kaj vidu, en kio konsistas lia granda forto, kaj per kio ni povus fortosuperi lin, ke ni ligu lin kaj humiligu lin; tiam ni donos al vi ĉiu po mil kaj cent arĝentaj moneroj.",
    ...
    "Kaj dum la embuskuloj sidis ĉe ŝi en alia ĉambro, ŝi diris al li:Filiŝtoj iras al vi, Ŝimŝon! Tiam li disŝiris la ŝnurojn, kiel oni disŝiras fadenon el stupo, kiam fajro ĝin bruldifektis. Kaj oni ne sciiĝis pri lia forto.",
    ...
    "Kaj li malkaŝis al ŝi sian tutan koron, kaj diris al ŝi:Tondilo ne tuŝis mian kapon, ĉar mi estas konsekrita al Dio de el la ventro de mia patrino. Se oni tondos miajn harojn, tiam forlasos min mia forto, mi senfortiĝos kaj fariĝos kiel la aliaj homoj.",
    "Kiam Delila vidis, ke li malkaŝis al ŝi sian tutan koron, ŝi sendis kaj vokigis la estrojn de la Filiŝtoj, dirante:Venu ĉi tiun fojon, ĉar li malkaŝis al mi sian tutan koron. Kaj venis al ŝi la estroj de la Filiŝtoj kaj alportis la arĝenton en siaj manoj.",
    ...
    "Kaj ŝi diris:Filiŝtoj iras al vi, Ŝimŝon! Li vekiĝis de sia dormo, kaj diris:Mi eliros, kiel ĉiufoje, kaj mi vigliĝos; sed li ne sciis, ke la Eternulo forlasis lin.",
    ...
    "Kaj la domo estis plena de viroj kaj virinoj, kaj tie estis ĉiuj estroj de la Filiŝtoj; kaj sur la tegmento estis ĉirkaŭ tri mil viroj kaj virinoj, kiuj rigardis la amuzadon de Ŝimŝon.",
