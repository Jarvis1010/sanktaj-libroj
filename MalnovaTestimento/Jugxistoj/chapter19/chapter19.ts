export const chapter19 = {
  ...
  verses: [
    ...
    "Sed la viro ne volis tranokti; li leviĝis kaj iris. Kaj li venis al la ĉirkaŭaĵo de Jebus (tio estas Jerusalem); kun li estis paro da ŝarĝitaj azenoj, kaj ankaŭ lia kromedzino.",
    ...
    "Sed jen iu maljunulo venis vespere de sia laboro de la kampo; li estis de la monto de Efraim kaj loĝis tiutempe en Gibea; kaj la loĝantoj de tiu loko estis Benjamenidoj.",
    ...
    "Kaj tiu diris al li:Ni iras el Bet-LeĤem de Jehuda al la deklivo de la monto de Efraim, de kie mi estas. Mi iris al Bet-LeĤem de Jehuda, kaj nun mi iras al la domo de la Eternulo; kaj neniu invitas min en la domon.",
    "Ni havas pajlon kaj manĝaĵon por niaj azenoj, ankaŭ panon kaj vinon mi havas por mi kaj por via sklavino, kaj por la junulo, kiu estas kun viaj sklavoj; nenio mankas al ni.",
    ...
    "Dum ili ĝojigadis sian koron, jen la loĝantoj de la urbo, homoj malmoralaj, ĉirkaŭis la domon, frapis je la pordo, kaj diris al la maljuna domomastro jene:Elirigu la homon, kiu venis en vian domon, ke ni lin ekkonu.",
    ...
    "Sed la homoj ne volis aŭskulti lin. Tiam la viro prenis sian kromedzinon kaj elirigis al ili sur la straton. Kaj ili ekkonis ŝin, kaj faris al si amuzon kun ŝi dum la tuta nokto, ĝis la mateno; kaj ili forliberigis ŝin, kiam leviĝis la matenruĝo.",
