export const chapter11 = {
  ...
  verses: [
    ...
    "Kaj la plejaĝuloj de Gilead diris al Jiftaĥ:Pro tio ni nun revenas al vi, ke vi iru kun ni, kaj ni batalos kontraŭ la Amonidoj, kaj vi estos ĉe ni estro de ĉiuj loĝantoj de Gilead.",
    "Kaj Jiftaĥ diris al la plejaĝuloj de Gilead:Se vi revenigas min, por batali kontraŭ la Amonidoj, kaj la Eternulo transdonos ilin al mi, ĉu tiam mi estos via estro?",
    "Kaj la plejaĝuloj de Gilead diris al Jiftaĥ:La Eternulo estu aŭskultanto inter ni, ke ni faros konforme al viaj vortoj.",
    "Tiam Jiftaĥ iris kun la plejaĝuloj de Gilead, kaj la popolo faris lin super si estro kaj kondukanto, kaj Jiftaĥ eldiris ĉiujn siajn vortojn antaŭ la Eternulo en Micpa.",
    ...
    "kaj tiam Izrael sendis senditojn al la reĝo de Edom, por diri:Permesu al mi trairi vian landon; sed la reĝo de Edom ne konsentis; ankaŭ al la reĝo de Moab estis sendite, sed li ne konsentis; tial Izrael restis en Kadeŝ;",
    "kaj li iris tra la dezerto kaj ĉirkaŭis la landon de Edom kaj la landon de Moab kaj venis de oriento al la lando de Moab kaj stariĝis tendare transe de Arnon, sed ne eniris en la limojn de Moab, ĉar Arnon estas la limo de Moab.",
    ...
    "Kaj la Eternulo, Dio de Izrael, transdonis Siĥonon kaj lian tutan popolon en la manojn de Izrael, kiu venkobatis ilin; kaj Izrael ekposedis la tutan landon de la Amoridoj, kiuj loĝis en tiu lando.",
    ...
    "Ĉu vi estas pli bona ol Balak, filo de Cipor kaj reĝo de Moab? ĉu tiu malpacis kun Izrael aŭ militis kontraŭ li?",
    "De la tempo, kiam Izrael ekloĝis en ĥeŝbon kaj en ĝiaj dependaĵoj kaj en Aroer kaj en ĝiaj dependaĵoj, kaj en ĉiuj urboj, kiuj estas apud Arnon, pasis jam tricent jaroj; kial vi ne forprenis ilin en tiu tempo?",
    ...
    "Kaj venis sur Jiftaĥon la spirito de la Eternulo, kaj li trapasis Gileadon kaj la regionon de Manase, kaj li trairis Micpan Gileadan, kaj de Micpa Gileada li iris al la Amonidoj.",
