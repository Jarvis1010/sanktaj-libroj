export const chapter4 = {
  ...
  verses: [
    ...
    "Kaj la Eternulo transdonis ilin en la manojn de Jabin, Kanaana reĝo, kiu reĝis en ĥacor; lia militistestro estis Sisera, kiu loĝis en ĥaroŝet- Goim.",
    ...
    "ŝi sidadis sub la palmo de Debora, inter Rama kaj Bet-El, sur la monto de Efraim; kaj la Izraelidoj venadis al ŝi por juĝo.",
    "Kaj ŝi sendis kaj alvokigis Barakon, filon de Abinoam, el Kedeŝ- Naftali, kaj diris al li:La Eternulo, Dio de Izrael, ordonis:Iru, konduku la militistaron sur la monton Tabor, kaj prenu kun vi dek mil virojn el la Naftaliidoj kaj el la Zebulunidoj;",
    ...
    "Kaj ŝi respondis:Bone, mi iros kun vi; sed vi ne havos gloron sur la vojo, kiun vi iros; ĉar en la manojn de virino la Eternulo transdonos Siseran. Kaj Debora leviĝis, kaj iris kun Barak al Kedeŝ.",
    ...
    "Sed Sisera forkuris piede al la tendo de Jael, edzino de la Kenido ĥeber; ĉar estis paco inter Jabin, reĝo de ĥacor, kaj la domo de la Kenido ĥeber.",
    "Kaj Jael eliris renkonte al Sisera, kaj diris al li:Eniru, mia sinjoro, eniru al mi; ne timu. Kaj li eniris al ŝi en la tendon, kaj ŝi kovris lin per litkovrilo.",
    ...
    "Kaj Jael, edzino de ĥeber, prenis najlon de la tendo kaj metis martelon en sian manon kaj aliris al li mallaŭte, kaj enbatis la najlon en lian tempion tiel, ke ĝi enpenetris en la teron. Li dormis, lacigita; kaj li mortis.",
