export const chapter4 = {
  ...
  verses: [
    ...
    "Reĥab kaj Baana, filoj de Rimon, la Beerotano, iris kaj venis en la varmego de la tago en la domon de Iŝ-Boŝet, kiam li kuŝis sian tagmezan kuŝadon.",
    "Kaj jen ili eniris en la mezon de la domo, kvazaŭ por preni tritikon, kaj frapis lin en la ventron; poste Reĥab kaj lia frato Baana forkuris.",
    ...
    "Kaj ili alportis la kapon de Iŝ-Boŝet al David en ĥebronon, kaj diris al la reĝo:Jen estas la kapo de Iŝ-Boŝet, filo de Saul, via malamiko, kiu serĉis vian animon; la Eternulo donis al nia sinjoro, la reĝo, venĝon hodiaŭ pro Saul kaj pro lia idaro.",
