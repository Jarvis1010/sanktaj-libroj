export const chapter21 = {
  ...
  verses: [
    ...
    "Tiam Ricpa, filino de Aja, prenis sakon, kaj etendis ĝin super si ĉe la roko, de la komenco de la rikolto ĝis ekpluvis sur ilin el la ĉielo; kaj ŝi ne permesis, ke la birdoj de la ĉielo ripozu sur ili tage, nek la kampaj bestoj nokte.",
    "Oni raportis al David, kion faris Ricpa, filino de Aja kaj kromvirino de Saul.",
    "Tiam David iris, kaj prenis la ostojn de Saul kaj la ostojn de lia filo Jonatan de la loĝantoj de Jabeŝ en Gilead, kiuj forŝtelis ilin el la strato de Bet-Ŝan, kie pendigis ilin la Filiŝtoj en la tago, kiam la Filiŝtoj venkobatis Saulon sur Gilboa.",
    ...
    "Kaj denove estis milito en Gat; tie estis viro tre altkreska, kiu havis sur la manoj kaj sur la piedoj po ses fingroj, sume dudek kvar; li ankaŭ naskiĝis al la giganto.",
