export const chapter16 = {
  ...
  verses: [
    ...
    "tial nia sinjoro diru al siaj servantoj, ke ili elserĉu homon, kiu povoscias ludi harpon:kaj kiam atakos vin la malbona spirito, sendita de Dio, li ekludos per sia mano, kaj tiam fariĝos al vi bone.",
    "Kaj Saul diris al siaj servantoj:Elserĉu al mi homon, kiu bone ludas, kaj venigu lin al mi.",
    "Tiam unu el la junuloj respondis kaj diris:Ĉe Jiŝaj la Bet-LeĤemano mi vidis filon, kiu povoscias ludi, kaj li estas fortulo kaj militkapablulo kaj prudenta en siaj paroloj kaj belaspekta, kaj la Eternulo estas kun li.",
