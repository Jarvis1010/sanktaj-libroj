export const chapter44 = {
  ...
  verses: [
    ...
    "Kaj tio servas al la homo kiel hejtilo; li prenas el tio kaj varmigas sin, li ankaŭ faras fajron kaj bakas panon; el tio sama li faras dion kaj adorkliniĝas antaŭ ĝi, li faras el ĝi idolon kaj adoras ĝin.",
    ...
    "Kaj li ne primeditas en sia koro, ne havas scion nek komprenon, por diri:Duonon de ĝi mi forbruligis en fajro, mi ankaŭ bakis sur ĝiaj karboj panon, mi rostis viandon kaj manĝis; ĉu do el la restaĵo mi faros abomenindaĵon? ĉu ŝtipon da ligno mi adoros?",
    ...
    "Ĝojkriu, ho ĉielo, ĉar la Eternulo tion faris; voku, profundo de la tero; sonigu kanton, ho montoj, arbaro kaj ĉiuj arboj en ĝi; ĉar la Eternulo liberigis Jakobon, kaj faris Sin glora per Izrael.",
    ...
    "kiu konfirmas la vorton de Sia servanto kaj plenumas la decidojn de Siaj senditoj; kiu diras pri Jerusalem:Ĝi havos multe da loĝantoj; kaj pri la urboj de Judujo:Ili estos rekonstruitaj, kaj iliajn ruinojn Mi restarigos;",
