export const chapter28 = {
  ...
  verses: [
    ...
    "Ĉar vi diras:Ni faris interligon kun la morto, kaj kun Ŝeol ni faris interkonsenton; kiam la frapanta vipo estos trapasanta, ĝi nin ne atingos, ĉar mensogon ni faris nia rifuĝejo kaj per malvero ni nin kovros.",
