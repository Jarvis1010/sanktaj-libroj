export const chapter36 = {
  ...
  verses: [
    ...
    "Tiam Eljakim kaj Ŝebna kaj JoaĤ diris al Rabŝake:Volu paroli al viaj sklavoj en la lingvo Siria, ĉar ni komprenas; sed ne parolu al ni Jude antaŭ la oreloj de la popolo, kiu estas sur la murego.",
    ...
    "Ne aŭskultu ĥizkijan; ĉar tiele diras la reĝo de Asirio:Faru kun mi pacon kaj eliru al mi, kaj manĝu ĉiu el sia vinberĝardeno kaj ĉiu de sia figarbo kaj trinku ĉiu la akvon de sia puto;",
