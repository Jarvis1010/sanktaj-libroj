export const chapter59 = {
  ...
  verses: [
    ...
    "Ni krimis kaj mensogis kontraŭ la Eternulo, kaj ni forturnis nin de nia Dio; ni parolis pri rabado kaj malbonagado, ni preparis kaj eligis el la koro vortojn mensogajn.",
    ...
    "Kaj Mi faras kun ili jenan interligon, diras la Eternulo:Mia spirito, kiu estas sur vi, kaj Miaj vortoj, kiujn Mi metis en vian buŝon, ne foriĝos de via buŝo nek de la buŝo de viaj infanoj nek de la buŝo de via plua idaro, de nun ĝis eterne, diras la Eternulo.",
  ],
